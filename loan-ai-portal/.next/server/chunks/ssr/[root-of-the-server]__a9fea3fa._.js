...
const metadata = {
    title: {
        default: "Loan AI Portal | Fast, compliant lending comparisons",
        template: "%s | Loan AI Portal"
    },
    description: "AI-powered lending comparison for US borrowers. Explore state-level regulations, lender compliance, and transparent APR estimates before applying.",
    metadataBase: new URL("https://www.loanaiportal.com"),
    icons: {
        icon: "/favicon.ico"
    },
    openGraph: {
        title: "Loan AI Portal",
        description: "Programmatic SEO platform offering state-aware loan comparisons, compliance guardrails, and AI navigation for US borrowers.",
        type: "website",
        locale: "en_US",
        url: "https://www.loanaiportal.com"
    },
    alternates: {
        languages: {
            "es-US": "https://www.loanaiportal.com/es"
        }
    }
};
