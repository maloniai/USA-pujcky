...
export const metadata: Metadata = {
  ...
  description: 'Complete your online application for a personal loan in Australia. Simple process, fast response, offers from ASIC-licensed lenders. No credit score impact to check rates.',
  robots: 'index, follow',
  openGraph: {
    title: 'Apply for Personal Loan in Australia',
    description: 'Online application for personal loans. ASIC-licensed lenders, fast approval, zero hidden costs.',
...
export default function AUApplyPage() {
  const schemaData = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    name: 'Apply for Personal Loan Australia',
    description: 'Loan application form for personal loans in Australia',
    url: 'https://loansai.com/au/apply',
    breadcrumb: {
      '@type': 'BreadcrumbList',
      itemListElement: [
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Get personalized loan offers from ASIC-licensed lenders in minutes
            </p>
          </div>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <label className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-gray-700">
                    I agree to the <Link href="/terms" className="text-blue-600 hover:underline">Terms of Service</Link> and <Link href="/privacy" className="text-blue-600 hover:underline">Privacy Policy</Link>. I understand that by submitting this form, my information will be shared with ASIC-licensed lenders for the purpose of providing loan offers.
                  </span>
                </label>
              </div>
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50 rounded-lg p-6">
              ...
              <ol className="space-y-2 text-sm text-gray-700">
                <li>1. We match you with suitable ASIC-licensed lenders</li>
                ...
                <li>5. Receive funds directly to your Australian bank account</li>
              </ol>
            </div>
            ...
            <div className="bg-green-50 rounded-lg p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li>• Compare offers from 50+ ASIC-licensed lenders</li>
