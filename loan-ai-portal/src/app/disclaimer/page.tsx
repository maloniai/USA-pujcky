...
export const metadata: Metadata = {
  title: 'Disclaimer - Important Loan Information | Loan AI Portal',
  description: 'Important disclaimers about personal loans, rates (5.99%-35.99% APR), approval not guaranteed, and responsible borrowing. We are NOT a lender - we match you with licensed USA lenders.',
  keywords: 'loan disclaimer, lending disclaimer, loan rates disclaimer, APR disclaimer, not a lender, loan matching service, financial disclaimer',
  alternates: {
    canonical: 'https://loan-platform.com/disclaimer',
  },
}
