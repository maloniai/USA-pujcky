    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'LoansAI - Compare Personal Loans Across 14 Countries',
      },
    ],
  },
  alternates: {
  ...
  const faqs = [
    {
      ...
      answer: "LoansAI uses artificial intelligence to analyze your financial profile and match you with licensed lenders in your country. Simply select your country, answer a few questions, and get personalized loan offers in 60 seconds. Our AI considers your credit profile, income, and local regulations to find the best rates."
    },
    {
      question: "Is LoansAI available in my country?",
      answer: `LoansAI currently operates in ${totalCountries}+ countries including the United States, Czech Republic, Canada, and more. We're rapidly expanding to Poland, Spain, Romania, Vietnam, Mexico, Colombia, Kazakhstan, South Africa, Australia, New Zealand, and the Philippines. Check our homepage to see if your country is live or coming soon.`
    },
    {
      question: "Is LoansAI free to use?",
      answer: "Yes, LoansAI is 100% free for borrowers. We never charge fees for comparing loan offers or matching you with lenders. We earn commissions from lender partners only when you successfully complete a loan, but this never affects the rates or terms you receive."
    },
    {
    ...
    },
    {
      ...
      answer: "Funding speed varies by country and lender. In the US, some lenders offer same-day or next-day funding for approved applicants. In Czech Republic, typical funding is 1-3 business days. Canada averages 2-5 business days. After approval, funds are typically deposited directly to your bank account."
    },
    {
      question: "Are all lenders licensed and regulated?",
      answer: "Yes. LoansAI only partners with licensed, regulated lenders in each market. US lenders comply with CFPB regulations and state banking laws. Czech lenders are regulated by ČNB (Czech National Bank). Canadian lenders follow FCAC guidelines and provincial regulations. We verify all licenses before adding lenders to our network."
    }
  ];
      ...
      <section className="relative container mx-auto px-4 py-16 md:py-24 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 opacity-10">
          <svg 
            ...
            role="img"
            aria-label="Global network of financial connections representing AI-powered loan matching across 14 countries"
          >
            <defs>
