        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="text-center mb-12">
            <div className="inline-block bg-blue-100 text-blue-700 px-4 py-2 rounded-full text-sm font-semibold mb-4">
              🇳🇿 FMA-Licensed Lenders Only
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Apply for a Personal Loan
            </h1>
            <p className="text-xl text-gray-600">
              Get personalized loan offers from FMA-licensed lenders in minutes
            </p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <select className="w-full px-4 py-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                  ...
                  <option value="wa">Western New Zealand</option>
                  <option value="sa">South New Zealand</option>
                  <option value="tas">Tasmania</option>
                  <option value="act">New Zealand Capital Territory</option>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <label className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-gray-700">
                    I agree to the <Link href="/terms" className="text-blue-600 hover:underline">Terms of Service</Link> and <Link href="/privacy" className="text-blue-600 hover:underline">Privacy Policy</Link>. I understand that by submitting this form, my information will be shared with FMA-licensed lenders for the purpose of providing loan offers.
                  </span>
                </label>
              </div>
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50 rounded-lg p-6">
              ...
              <ol className="space-y-2 text-sm text-gray-700">
                <li>1. We match you with suitable FMA-licensed lenders</li>
                ...
                <li>5. Receive funds directly to your New Zealand bank account</li>
              </ol>
            </div>
            ...
            <div className="bg-green-50 rounded-lg p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li>• Compare offers from 50+ FMA-licensed lenders</li>
