...
import { podkarpackieData } from '@/data/podkarpackie';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  const cityData = podkarpackieData.cities[params.city];
    ...
    <>
      <div className="container mx-auto px-4 py-8">
        ...
        <nav className="text-sm mb-6 text-gray-600">
          ...
          <Link href="/pl/regions/podkarpackie" className="hover:text-blue-600">{region.name}</Link>
          <span className="mx-2">/</span>
        ...
        <div className="mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {cityData.nearbyCities.map((nearbyCity) => (
              <Link
                key={nearbyCity.slug}
                href={`/pl/regions/podkarpackie/${nearbyCity.slug}`}
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 3,
                name: cityData.name,
                item: `https://example.com/pl/regions/podkarpackie/${params.city}`
              }
            ]
          })
        }}
