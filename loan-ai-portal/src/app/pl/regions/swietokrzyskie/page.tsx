...
import { swietokrzyskieData } from '@/data/pl-swietokrzyskie';
import { StickyApplyButton } from '@/components/sticky-apply-button';

export const metadata: Metadata = {
  title: 'Pożyczki w Świętokrzyskie – Porównaj oferty 2025',
  description: 'Kompleksowy przewodnik po pożyczkach i kredytach w województwie swietokrzyskie. Sprawdź najlepsze oferty kredytowe w regionie.',
  keywords: 'pożyczki swietokrzyskie, kredyty Świętokrzyskie'
};

export default function ŚwiętokrzyskieRegionPage() {
  const { region } = swietokrzyskieData;
        ...
        <div className="mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {region.featuredCities.map((city) => (
              <Link
                key={city.slug}
                href={`/pl/regions/swietokrzyskie/${city.slug}`}
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: region.name,
                item: `https://example.com/pl/regions/swietokrzyskie`
              }
            ]
          })
        }}
