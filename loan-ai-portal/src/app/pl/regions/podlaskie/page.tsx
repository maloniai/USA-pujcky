...
export const metadata: Metadata = {
  title: 'Pożyczki w Podlaskie – Porównaj oferty 2025',
  description: 'Kompleksowy przewodnik po pożyczkach i kredytach w województwie podlaskie. Sprawdź najlepsze oferty kredytowe w regionie.',
  keywords: 'pożyczki podlaskie, kredyty Podlaskie'
};

export default function PodlaskieRegionPage() {
        ...
        <div className="mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {region.featuredCities.map((city) => (
              <Link
                key={city.slug}
                href={`/pl/regions/podlaskie/${city.slug}`}
