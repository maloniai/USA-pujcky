...
import { lubelskieRegionContent } from '@/data/pl-lubelskie'

const currentYear = new Date().getFullYear()
const canonicalPath = '/pl/regions/lubelskie'
        ...
        <header className="border-b border-blue-100 bg-gradient-to-br from-blue-50 via-white to-blue-100">
          <div className="mx-auto max-w-6xl px-4 py-16">
            <p className="text-sm font-semibold uppercase tracking-wide text-blue-700">
              Lubelskie • Przewodnik regionalny {currentYear}
            </p>
          ...
          <div className="mx-auto max-w-6xl px-4">
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {topCities.map((city) => (
                <Link
                  key={city.slug}
                  href={`/pl/regions/lubelskie/${city.slug}`}
