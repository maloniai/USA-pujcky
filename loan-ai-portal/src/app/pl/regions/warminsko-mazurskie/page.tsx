...
export const metadata: Metadata = {
  title: 'Pożyczki w Warmińsko-Mazurskie – Porównaj oferty 2025',
  description: 'Kompleksowy przewodnik po pożyczkach i kredytach w województwie warminsko-mazurskie. Sprawdź najlepsze oferty kredytowe w regionie.',
        ...
        <div className="mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {region.featuredCities.map((city) => (
              <Link
                key={city.slug}
                href={`/pl/regions/warminsko-mazurskie/${city.slug}`}
