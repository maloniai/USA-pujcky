...
import { zachodniopomorskieCities } from '@/data/pl-zachodniopomorskie'
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const cityData = zachodniopomorskieCities[params.city]
  ...
  return {
    ...
    alternates: {
      canonical: `/pl/regions/zachodniopomorskie/${params.city}`,
    },
    openGraph: {
      title: cityData.metaTitleTemplate,
      description: cityData.metaDescriptionTemplate,
      url: `/pl/regions/zachodniopomorskie/${params.city}`,
      locale: 'pl_PL',
      type: 'website',
    },
    keywords: [
...
export default function CityPage({ params }: PageProps) {
  ...
  const breadcrumbItems = [
    ...
    { name: `Pożyczki ${cityData.regionName}`, url: '/pl/regions/zachodniopomorskie', position: 3 },
    { name: `Pożyczki ${cityData.name}`, url: `/pl/regions/zachodniopomorskie/${params.city}`, position: 4 },
  ]
        ...
        <header className="border-b border-blue-100 bg-gradient-to-br from-blue-50 via-white to-blue-100">
          <div className="mx-auto max-w-6xl px-4 py-12">
            <nav className="mb-4 flex items-center gap-2 text-sm text-blue-600">
              ...
              <Link href="/pl/regions/zachodniopomorskie" className="hover:underline">{cityData.regionName}</Link>
              <span aria-hidden>›</span>
        ...
        <section className="bg-white py-12">
          <div className="mx-auto max-w-6xl px-4">
            ...
            <div className="mt-8 text-center">
              <Link
                href="/pl/regions/zachodniopomorskie"
...
export function generateStaticParams() {
  return Object.keys(zachodniopomorskieCities).map((city) => ({
    city,
  }))
}
