...
import { lubuskieData } from '@/data/pl-lubuskie';
import { StickyApplyButton } from '@/components/sticky-apply-button';

export const metadata: Metadata = {
  title: 'Pożyczki w Lubuskie – Porównaj oferty 2025',
  description: 'Kompleksowy przewodnik po pożyczkach i kredytach w województwie lubuskie. Sprawdź najlepsze oferty kredytowe w regionie.',
  keywords: 'pożyczki lubuskie, kredyty Lubuskie'
};

export default function LubuskieRegionPage() {
  const { region } = lubuskieData;
        ...
        <div className="mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {region.featuredCities.map((city) => (
              <Link
                key={city.slug}
                href={`/pl/regions/lubuskie/${city.slug}`}
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: region.name,
                item: `https://example.com/pl/regions/lubuskie`
              }
            ]
          })
        }}
