...
function getCityUniqueContent(cityName: string, regionName: string, citySlug: string): {
  intro: string;
...
export default function CityPage({ params }: CityPageProps) {
  ...
  const currentYear = new Date().getFullYear();
  const cityContent = getCityUniqueContent(params.city, region.nameKk, params.city);
