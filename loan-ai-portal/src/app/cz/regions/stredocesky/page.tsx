...
import { stredoceskyRegionContent } from '@/data/cz-stredocesky'

const currentYear = new Date().getFullYear()
const canonicalPath = '/cz/regions/stredocesky'
...
export function generateMetadata(): Metadata {
  ...
  return {
    ...
    keywords: [
      'půjčky Středočeský kraj',
      'osobní půjčky Středočeský',
      'konsolidace Středočeský kraj',
      'AI srovnání půjček',
...
export default function CentralBohemiaRegionPage() {
  return (
    <>
      ...
      <main className="flex-1 bg-slate-50">
              ...
              <div>
                ...
                <div className="mt-6 grid gap-4 md:grid-cols-2">
                  <div className="rounded-2xl border border-blue-200 bg-white/80 p-4 shadow-sm">
                    <p className="text-lg font-semibold text-blue-900">Regionální limity</p>
                    <p className="mt-1 text-sm text-blue-900/70">
                      Sledujeme DSTI, DTI a dotační programy napříč průmyslovými zónami, suburbemi i venkovskými oblastmi.
                    </p>
                  </div>
                  <div className="rounded-2xl border border-blue-200 bg-white/80 p-4 shadow-sm">
                    <p className="text-lg font-semibold text-blue-900">AI skóre</p>
                    <p className="mt-1 text-sm text-blue-900/70">
                      Výsledky řadíme podle RPSN, celkového přeplacení a dostupnosti licencovaných partnerů.
                    </p>
                  </div>
                </div>
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-6xl px-4">
            <h2 className="text-3xl font-semibold text-blue-900">Co řeší domácnosti a podnikatelé ve Středočeském kraji</h2>
            <p className="mt-3 max-w-3xl text-sm text-blue-900/80">
              AI model průběžně analyzuje sazebníky, registry dlužníků i krajské výzvy. Díky tomu nabízíme doporučení, která zohledňují rozdíly mezi průmyslovými centry, lázeňskými oblastmi a příměstskými satelity Prahy.
            </p>
          ...
          <div className="grid gap-8 md:grid-cols-[1.3fr_1fr]">
            <div>
              ...
              <p className="mt-3 text-sm text-blue-900/80">
                Než podepíšete smlouvu, ověřte licenci poskytovatele a využijte dostupné bezplatné poradenské služby v regionu.
              </p>
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-6xl px-4">
            <h2 className="text-3xl font-semibold text-blue-900">Licencovaní poskytovatelé ve Středočeském kraji</h2>
        ...
        <section className="mx-auto max-w-6xl px-4 py-16">
          ...
          <p className="mt-3 max-w-3xl text-sm text-blue-900/80">
            Každé město ve Středočeském kraji má vlastní průvodce s reprezentativními příklady, licencovanými poskytovateli a lokálními doporučeními.
          </p>
          <div className="mt-8 grid gap-5 md:grid-cols-3">
            {topCities.map((city) => (
              <Card key={city.slug} className="border-blue-100 shadow-sm">
                ...
                <CardContent>
                  <Link
                    href={`/cz/regions/stredocesky/${city.slug}`}
