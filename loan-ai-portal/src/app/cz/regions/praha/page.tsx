...
import { pragueRegionContent } from '@/data/cz-prague'

const currentYear = new Date().getFullYear()
const canonicalPath = '/cz/regions/praha'
...
const breadcrumbItems = [
  ...
  { name: 'Půjčky Praha', url: canonicalPath, position: 3 },
]
...
export function generateMetadata(): Metadata {
  ...
  return {
    ...
    keywords: [
      'půjčky Praha',
      'osobní půjčky Praha',
      'konsolidace půjček Praha',
      'AI srovnání půjček',
      'registrační limity ČNB',
    ],
  }
}

export default function PragueRegionPage() {
  return (
    <>
      ...
      <main className="flex-1 bg-slate-50">
        ...
        <header className="border-b border-blue-100 bg-gradient-to-br from-blue-50 via-white to-blue-100">
          <div className="mx-auto max-w-6xl px-4 py-16">
            <p className="text-sm font-semibold uppercase tracking-wide text-blue-700">
              Praha • Regionální průvodce {currentYear}
            </p>
            ...
            <div className="mt-8 grid gap-8 lg:grid-cols-[1.4fr_1fr]">
              <div>
                ...
                <div className="mt-6 grid gap-4 md:grid-cols-2">
                  <div className="rounded-2xl border border-blue-200 bg-white/80 p-4 shadow-sm">
                    <p className="text-lg font-semibold text-blue-900">Limity ČNB</p>
                    <p className="mt-1 text-sm text-blue-900/70">
                      Hlídáme DSTI, DTI i zveřejněné sazby licencovaných bank a fintech společností.
                    </p>
                  </div>
                  <div className="rounded-2xl border border-blue-200 bg-white/80 p-4 shadow-sm">
                    <p className="text-lg font-semibold text-blue-900">AI skóre</p>
                    <p className="mt-1 text-sm text-blue-900/70">
                      Výsledky řadíme podle RPSN, celkového přeplacení a rychlosti výplaty prostředků.
                    </p>
                  </div>
                </div>
              ...
              <VolsorLoanForm
                ...
                country="cs"
                affiliate={9100}
                campaign="praha-region"
                partnerName="Volsor Praha"
              />
            </div>
          </div>
        </header>
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-6xl px-4">
            <h2 className="text-3xl font-semibold text-blue-900">Co řeší pražské domácnosti a podnikatelé</h2>
            <p className="mt-3 max-w-3xl text-sm text-blue-900/80">
              Naše AI průběžně analyzuje lokální sazebníky, registry dlužníků i dotační programy. Díky tomu nabízíme doporučení,
              která respektují regulatorní limity a zohledňují dostupnost poboček napříč všemi městskými částmi.
            </p>
          ...
          <div className="grid gap-8 md:grid-cols-[1.3fr_1fr]">
            <div>
              ...
              <p className="mt-3 text-sm text-blue-900/80">
                Než podepíšete smlouvu, ověřte licenci poskytovatele a využijte dostupné bezplatné poradenské služby v Praze.
              </p>
            ...
            <div className="rounded-3xl border border-blue-100 bg-blue-50/50 p-6 shadow-sm">
              ...
              <p className="mt-2 text-sm text-blue-900/80">
                Náš tým v Praze 1 vám připraví nezávazné srovnání do 24 hodin. Zavolejte na{' '}
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-6xl px-4">
            <h2 className="text-3xl font-semibold text-blue-900">Licencovaní poskytovatelé se silným pokrytím v Praze</h2>
        ...
        <section className="mx-auto max-w-6xl px-4 py-16">
          <h2 className="text-3xl font-semibold text-blue-900">Vyberte si městskou část</h2>
          <p className="mt-3 max-w-3xl text-sm text-blue-900/80">
            Pro každou městskou část připravujeme detailní průvodce s reprezentativními příklady, licencovanými poskytovateli a lokálními upozorněními.
          </p>
          <div className="mt-8 grid gap-5 md:grid-cols-3">
            {topCities.map((city) => (
              <Card key={city.slug} className="border-blue-100 shadow-sm">
                ...
                <CardContent>
                  <Link
                    href={`/cz/regions/praha/${city.slug}`}
