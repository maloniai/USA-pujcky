  ...
  return (
    <>
      ...
      <main className="flex-1 bg-slate-50">
          ...
          <div className="mx-auto max-w-6xl px-4">
            ...
            <div className="mt-8 space-y-4 max-w-3xl">
              ...
              <details className="rounded-2xl border border-blue-100 bg-white p-5 shadow-sm">
                ...
                <p className="mt-3 text-sm text-blue-909/80">
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-6xl px-4">
            <h2 className="text-3xl font-semibold text-blue-900 mb-8">Sousední regiony</h2>
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <Link href="/cz/regions/plzensky" className="block">
                <Card className="border-blue-100 shadow-sm hover:shadow-md transition-shadow">
                  <CardHeader>
                    <CardTitle className="text-xl text-blue-900">Plzeňský kraj</CardTitle>
                  </CardHeader>
                  <CardContent className="text-sm text-blue-900/80">
                    <p>Průměrné RPSN 17,2 % • Sídlo: Plzeň</p>
                  </CardContent>
                </Card>
              </Link>
              <Link href="/cz/regions/ustecky" className="block">
                <Card className="border-blue-100 shadow-sm hover:shadow-md transition-shadow">
                  <CardHeader>
                    <CardTitle className="text-xl text-blue-900">Ústecký kraj</CardTitle>
                  </CardHeader>
                  <CardContent className="text-sm text-blue-900/80">
                    <p>Průměrné RPSN 19,3 % • Sídlo: Ústí nad Labem</p>
                  </CardContent>
                </Card>
              </Link>
