...
import { karlovarskyRegionContent, karlovarskyCities } from '@/data/cz-karlovarsky';
import { VolsorLoanForm } from '@/components/cz/volsor-loan-form';

const currentYear = new Date().getFullYear();

export const metadata: Metadata = {
  title: `Porovnání půjček v Karlovarském kraji ${currentYear} | Loan-Platform.com`,
  description: `Srovnejte půjčky v Karlovarském kraji. Osobní úvěry od ověřených poskytovatelů v Karlových Varech, Chebu, Sokolově a dalších městech. Průměrné RPSN ${karlovarskyRegionContent.averageRpsn}%.`,
  keywords: ['půjčky Karlovarský kraj', 'úvěr Karlovy Vary', 'nebankovní půjčka', 'rychlá půjčka', 'půjčka online'],
  openGraph: {
    title: `Půjčky v Karlovarském kraji ${currentYear}`,
    description: `Porovnejte licencované poskytovatele půjček v Karlovarském kraji. Průměrné RPSN ${karlovarskyRegionContent.averageRpsn}%.`,
    type: 'website'
  }
};

export default function KarlovarskyRegionPage() {
  const region = karlovarskyRegionContent;
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      ...
      <section className="max-w-7xl mx-auto px-4 -mt-8 mb-12 relative z-10">
        <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8">
          ...
          <p className="text-gray-600 mb-6">
            Vyplňte formulář a obdržíte nabídky od licencovaných poskytovatelů v Karlovarském kraji
          </p>
          <VolsorLoanForm affiliate={9280} campaign={`karlovarsky-${region.slug}`} partnerName={`Volsor ${region.capital}`} />
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 mb-12">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Regulace půjček v Karlovarském kraji</h2>
      ...
      <section className="max-w-7xl mx-auto px-4 mb-12">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Doporučení poskytovatelé v Karlovarském kraji</h2>
          <div className="grid md:grid-cols-2 gap-6">
      ...
      <section className="max-w-7xl mx-auto px-4 mb-12">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Půjčky ve městech Karlovarského kraje</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {region.topCities.map((city) => (
              <Link
                key={city.slug}
                href={`/cz/regions/karlovarsky/${city.slug}`}
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                item: 'https://loan-platform.com/cz/regions/karlovarsky'
              }
            ]
          })
        }}
