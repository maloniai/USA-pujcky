...
import { pardubickyRegionContent, pardubickyCities } from '@/data/cz-pardubicky';
import { VolsorLoanForm } from '@/components/cz/volsor-loan-form';

const currentYear = new Date().getFullYear();

export const metadata: Metadata = {
  title: `Porovnání půjček v Pardubickém kraji ${currentYear} | Loan-Platform.com`,
  description: `Srovnejte půjčky v Pardubickém kraji. Osobní úvěry od ověřených poskytovatelů v Pardubicích, Chrudimi, Svitavách a dalších městech. Průměrné RPSN ${pardubickyRegionContent.averageRpsn}%.`,
  keywords: ['půjčky Pardubický kraj', 'úvěr Pardubice', 'nebankovní půjčka', 'rychlá půjčka', 'půjčka online'],
  openGraph: {
    title: `Půjčky v Pardubickém kraji ${currentYear}`,
    description: `Porovnejte licencované poskytovatele půjček v Pardubickém kraji. Průměrné RPSN ${pardubickyRegionContent.averageRpsn}%.`,
    type: 'website'
  }
};

export default function PardubickyRegionPage() {
  const region = pardubickyRegionContent;
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      ...
      <section className="max-w-7xl mx-auto px-4 -mt-8 mb-12 relative z-10">
        <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8">
          ...
          <p className="text-gray-600 mb-6">
            Vyplňte formulář a obdržíte nabídky od licencovaných poskytovatelů v Pardubickém kraji
          </p>
          <VolsorLoanForm affiliate={9320} campaign={`pardubicky-${region.slug}`} partnerName={`Volsor ${region.capital}`} />
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 mb-12">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Regulace půjček v Pardubickém kraji</h2>
      ...
      <section className="max-w-7xl mx-auto px-4 mb-12">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Doporučení poskytovatelé v Pardubickém kraji</h2>
          <div className="grid md:grid-cols-2 gap-6">
      ...
      <section className="max-w-7xl mx-auto px-4 mb-12">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Půjčky ve městech Pardubického kraje</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {region.topCities.map((city) => (
              <Link
                key={city.slug}
                href={`/cz/regions/pardubicky/${city.slug}`}
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                item: 'https://loan-platform.com/cz/regions/pardubicky'
              }
            ]
          })
        }}
