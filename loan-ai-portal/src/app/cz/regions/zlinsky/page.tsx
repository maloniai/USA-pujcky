...
import { zlinskyRegionContent, zlinskyCities } from '@/data/cz-zlinsky';
import { VolsorLoanForm } from '@/components/cz/volsor-loan-form';

const currentYear = new Date().getFullYear();

export const metadata: Metadata = {
  title: `Porovnání půjček ve Zlínském kraji ${currentYear} | Loan-Platform.com`,
  description: `Srovnejte půjčky ve Zlínském kraji. Osobní úvěry od ověřených poskytovatelů ve Zlíně, Uherském Hradišti, Vsetíně a dalších městech. Průměrné RPSN ${zlinskyRegionContent.averageRpsn}%.`,
  keywords: ['půjčky Zlínský kraj', 'úvěr Zlín', 'nebankovní půjčka', 'rychlá půjčka', 'půjčka online'],
  openGraph: {
    title: `Půjčky ve Zlínském kraji ${currentYear}`,
    description: `Porovnejte licencované poskytovatele půjček ve Zlínském kraji. Průměrné RPSN ${zlinskyRegionContent.averageRpsn}%.`,
    type: 'website'
  }
};

export default function ZlinskyRegionPage() {
  const region = zlinskyRegionContent;
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      ...
      <section className="max-w-7xl mx-auto px-4 -mt-8 mb-12 relative z-10">
        <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8">
          ...
          <p className="text-gray-600 mb-6">
            Vyplňte formulář a obdržíte nabídky od licencovaných poskytovatelů ve Zlínském kraji
          </p>
          <VolsorLoanForm affiliate={9350} campaign={`zlinsky-${region.slug}`} partnerName={`Volsor ${region.capital}`} />
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 mb-12">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Regulace půjček ve Zlínském kraji</h2>
      ...
      <section className="max-w-7xl mx-auto px-4 mb-12">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Doporučení poskytovatelé ve Zlínském kraji</h2>
          <div className="grid md:grid-cols-2 gap-6">
      ...
      <section className="max-w-7xl mx-auto px-4 mb-12">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Půjčky ve městech Zlínského kraje</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {region.topCities.map((city) => (
              <Link
                key={city.slug}
                href={`/cz/regions/zlinsky/${city.slug}`}
