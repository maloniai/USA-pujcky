...
import { kralovehradeckyRegionContent, kralovehradeckyCities } from '@/data/cz-kralovehradecky';
import { VolsorLoanForm } from '@/components/cz/volsor-loan-form';

const currentYear = new Date().getFullYear();

export const metadata: Metadata = {
  title: `Porovnání půjček v Královéhradeckém kraji ${currentYear} | Loan-Platform.com`,
  description: `Srovnejte půjčky v Královéhradeckém kraji. Osobní úvěry od ověřených poskytovatelů v Hradci Králové, Trutnově, Náchodě a dalších městech. Průměrné RPSN ${kralovehradeckyRegionContent.averageRpsn}%.`,
  keywords: ['půjčky Královéhradecký kraj', 'úvěr Hradec Králové', 'nebankovní půjčka', 'rychlá půjčka', 'půjčka online'],
  openGraph: {
    title: `Půjčky v Královéhradeckém kraji ${currentYear}`,
    description: `Porovnejte licencované poskytovatele půjček v Královéhradeckém kraji. Průměrné RPSN ${kralovehradeckyRegionContent.averageRpsn}%.`,
    type: 'website'
  }
};

export default function KralovehradeckyRegionPage() {
  const region = kralovehradeckyRegionContent;
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      ...
      <section className="max-w-7xl mx-auto px-4 -mt-8 mb-12 relative z-10">
        <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8">
          ...
          <p className="text-gray-600 mb-6">
            Vyplňte formulář a obdržíte nabídky od licencovaných poskytovatelů v Královéhradeckém kraji
          </p>
          <VolsorLoanForm affiliate={9310} campaign={`kralovehradecky-${region.slug}`} partnerName={`Volsor ${region.capital}`} />
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 mb-12">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Regulace půjček v Královéhradeckém kraji</h2>
      ...
      <section className="max-w-7xl mx-auto px-4 mb-12">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Doporučení poskytovatelé v Královéhradeckém kraji</h2>
          <div className="grid md:grid-cols-2 gap-6">
      ...
      <section className="max-w-7xl mx-auto px-4 mb-12">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Půjčky ve městech Královéhradeckého kraje</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {region.topCities.map((city) => (
              <Link
                key={city.slug}
                href={`/cz/regions/kralovehradecky/${city.slug}`}
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                item: 'https://loan-platform.com/cz/regions/kralovehradecky'
              }
            ]
          })
        }}
