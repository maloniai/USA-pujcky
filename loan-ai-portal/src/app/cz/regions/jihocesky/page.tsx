...
import { jihoceskyRegionContent } from '@/data/cz-jihocesky'

const currentYear = new Date().getFullYear()
const canonicalPath = '/cz/regions/jihocesky'
...
export function generateMetadata(): Metadata {
  ...
  return {
    ...
    keywords: [
      'půjčky Jihočeský kraj',
      'půjčky České Budějovice',
      'konsolidace Jihočeský kraj',
      'AI srovnání půjček',
...
export default function SouthBohemiaRegionPage() {
  return (
    <>
      ...
      <main className="flex-1 bg-slate-50">
                ...
                <div className="mt-6 grid gap-4 md:grid-cols-2">
                  <div className="rounded-2xl border border-blue-200 bg-white/80 p-4 shadow-sm">
                    ...
                    <p className="mt-1 text-sm text-blue-900/70">
                      Sledujeme DTI, DSTI a dotační programy pro rybníkářství, energetiku i turismus.
                    </p>
                  </div>
                  <div className="rounded-2xl border border-blue-200 bg-white/80 p-4 shadow-sm">
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-6xl px-4">
            <h2 className="text-3xl font-semibold text-blue-900">Co řeší domácnosti a podnikatelé v Jihočeském kraji</h2>
            <p className="mt-3 max-w-3xl text-sm text-blue-900/80">
              AI model analyzuje sazebníky, registry dlužníků i krajské výzvy. Díky tomu nabízíme doporučení, která zohledňují rozdíly mezi lázeňskými městy, průmyslovými zónami a turistickými oblastmi Lipenska.
            </p>
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-6xl px-4">
            <h2 className="text-3xl font-semibold text-blue-900">Licencovaní poskytovatelé v Jihočeském kraji</h2>
        ...
        <section className="mx-auto max-w-6xl px-4 py-16">
          ...
          <p className="mt-3 max-w-3xl text-sm text-blue-900/80">
            Každé město v Jihočeském kraji má vlastní průvodce s reprezentativními příklady, licencovanými poskytovateli a lokálními doporučeními.
          </p>
          <div className="mt-8 grid gap-5 md:grid-cols-3">
            {topCities.map((city) => (
              <Card key={city.slug} className="border-blue-100 shadow-sm">
                ...
                <CardContent>
                  <Link
                    href={`/cz/regions/jihocesky/${city.slug}`}
