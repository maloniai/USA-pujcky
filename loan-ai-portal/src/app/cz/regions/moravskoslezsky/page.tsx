...
import { moravskoslezskyRegionContent, moravskoslezskyCityContent } from '@/data/cz-moravskoslezsky'

const currentYear = new Date().getFullYear()
const regionCode = 'moravskoslezsky'
...
export default function MoravskoslezskyRegionPage() {
  return (
    <>
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-6xl px-4">
            ...
            <div className="mt-8 grid gap-5 md:grid-cols-3">
              {moravskoslezskyCityContent.map((city) => (
