...
import { moravskoslezskyRegionContent } from '@/data/cz-moravskoslezsky'

const currentYear = new Date().getFullYear()
const canonicalPath = '/cz/regions/moravskoslezsky'
...
export function generateMetadata(): Metadata {
  ...
  return {
    ...
    keywords: [
      'půjčky Moravskoslezský kraj',
      'osobní půjčky Ostrava',
      'konsolidace Moravskoslezský kraj',
      'AI srovnání půjček',
...
export default function MoravianSilesianRegionPage() {
  return (
    <>
      ...
      <main className="flex-1 bg-slate-50">
          ...
          <div className="mx-auto max-w-6xl px-4 py-16">
            ...
            <div className="mt-8 grid gap-8 lg:grid-cols-[1.4fr_1fr]">
              <div>
                ...
                <div className="mt-6 grid gap-4 md:grid-cols-2">
                  <div className="rounded-2xl border border-blue-200 bg-white/80 p-4 shadow-sm">
                    <p className="text-lg font-semibold text-blue-900">Ostrava – průmyslové centrum</p>
                    <p className="mt-1 text-sm text-blue-900/70">
                      Třetí největší město ČR procházející transformací od těžkého průmyslu k moderním službám a IT. Diverzifikovaná poptávka po úvěrech.
                    </p>
                  </div>
                  <div className="rounded-2xl border border-blue-200 bg-white/80 p-4 shadow-sm">
                    <p className="text-lg font-semibold text-blue-900">AI skóre pro Moravskoslezský kraj</p>
                    <p className="mt-1 text-sm text-blue-900/70">
                      Výsledky řadíme podle RPSN, celkového přeplacení a dostupnosti licencovaných partnerů v regionu od Ostravy až po příhraniční oblasti.
                    </p>
                  </div>
                </div>
              ...
              <VolsorLoanForm
                ...
                country="cs"
                affiliate={9260}
                campaign="moravskoslezsky-region"
                partnerName="Volsor Moravskoslezský"
                theme="old_styled"
              />
            </div>
          </div>
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-6xl px-4">
            <h2 className="text-3xl font-semibold text-blue-900">Co řeší domácnosti a podnikatelé v Moravskoslezském kraji</h2>
            <p className="mt-3 max-w-3xl text-sm text-blue-900/80">
              AI model průběžně analyzuje sazebníky, registry dlužníků i krajské specifika. Díky tomu nabízíme doporučení, která zohledňují rozdíly mezi průmyslovými centry, oblastmi v transformaci a příhraničními regiony s Polskem.
            </p>
          ...
          <div className="grid gap-8 md:grid-cols-[1.3fr_1fr]">
            <div>
              ...
              <p className="mt-3 text-sm text-blue-900/80">
                Než podepíšete smlouvu, ověřte licenci poskytovatele a využijte dostupné bezplatné poradenské služby v Moravskoslezském kraji.
              </p>
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-6xl px-4">
            <h2 className="text-3xl font-semibold text-blue-900">Licencovaní poskytovatelé v Moravskoslezském kraji</h2>
        ...
        <section className="mx-auto max-w-6xl px-4 py-16">
          ...
          <p className="mt-3 max-w-3xl text-sm text-blue-900/80">
            Každé město v Moravskoslezském kraji má vlastní průvodce s reprezentativními příklady, licencovanými poskytovateli a lokálními doporučeními.
          </p>
          <div className="mt-8 grid gap-5 md:grid-cols-3">
            {topCities.map((city) => (
              <Card key={city.slug} className="border-blue-100 shadow-sm">
                ...
                <CardContent>
                  <Link
                    href={`/cz/regions/moravskoslezsky/${city.slug}`}
