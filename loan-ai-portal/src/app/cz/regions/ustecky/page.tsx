...
import { usteckyRegionContent, usteckyCities } from '@/data/cz-ustecky';
import { VolsorLoanForm } from '@/components/cz/volsor-loan-form';

const currentYear = new Date().getFullYear();

export const metadata: Metadata = {
  title: `Porovnání půjček v Ústeckém kraji ${currentYear} | Loan-Platform.com`,
  description: `Srovnejte půjčky v Ústeckém kraji. Osobní úvěry od ověřených poskytovatelů v Ústí nad Labem, Mostě, Děčíně a dalších městech. Průměrné RPSN ${usteckyRegionContent.averageRpsn}%.`,
  keywords: ['půjčky Ústecký kraj', 'úvěr Ústí nad Labem', 'nebankovní půjčka', 'rychlá půjčka', 'půjčka online'],
  openGraph: {
    title: `Půjčky v Ústeckém kraji ${currentYear}`,
    description: `Porovnejte licencované poskytovatele půjček v Ústeckém kraji. Průměrné RPSN ${usteckyRegionContent.averageRpsn}%.`,
    type: 'website'
  }
};

export default function UsteckyRegionPage() {
  const region = usteckyRegionContent;
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      ...
      <section className="max-w-7xl mx-auto px-4 -mt-8 mb-12 relative z-10">
        <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8">
          ...
          <p className="text-gray-600 mb-6">
            Vyplňte formulář a obdržíte nabídky od licencovaných poskytovatelů v Ústeckém kraji
          </p>
          <VolsorLoanForm affiliate={9290} campaign={`ustecky-${region.slug}`} partnerName={`Volsor ${region.capital}`} />
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 mb-12">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Regulace půjček v Ústeckém kraji</h2>
      ...
      <section className="max-w-7xl mx-auto px-4 mb-12">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Doporučení poskytovatelé v Ústeckém kraji</h2>
          <div className="grid md:grid-cols-2 gap-6">
      ...
      <section className="max-w-7xl mx-auto px-4 mb-12">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Půjčky ve městech Ústeckého kraje</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {region.topCities.map((city) => (
              <Link
                key={city.slug}
                href={`/cz/regions/ustecky/${city.slug}`}
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 3,
                name: 'Ústecký kraj',
                item: 'https://loan-platform.com/cz/regions/ustecky'
              }
            ]
          })
        }}
