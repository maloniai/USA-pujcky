...
export const metadata = {
  title: 'Půjčky Harrachov, Liberecký kraj – Srovnání 2025',
  description: 'Najděte nejlepší půjčky v Harrachov. Kompletní informace o regulacích, podmínkách a licencovaných poskytovatelích v Libereckém kraji.',
}

export default function HarrachovPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <CardContent>
            <div className="bg-gray-100 p-8 rounded-lg text-center">
              <p className="text-gray-600 mb-4">
                Zde se zobrazí srovnávač nabídek od licencovaných poskytovatelů pro Harrachov
              </p>
      ...
      <section className="mb-10">
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Jaké typy půjček jsou dostupné v Harrachov?</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-700">
                V Harrachov jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace 
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                <Link href="/cz/kraje/liberecky-kraj/desna" className="block text-blue-600 hover:underline">
                  Půjčky Desná →
                </Link>
                <Link href="/cz/kraje/liberecky-kraj/rokytnice-nad-jizerou" className="block text-blue-600 hover:underline">
                  Půjčky Rokytnice nad Jizerou →
                </Link>
            ...
            '@graph': [
              ...
              },
              {
                ...
                mainEntity: [
                  {
                    '@type': 'Question',
                    name: 'Jaké typy půjček jsou dostupné v Harrachov?',
                    acceptedAnswer: {
                      '@type': 'Answer',
                      text: 'V Harrachov jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace dluhů.',
                    },
                  },
                ],
              },
              {
                ...
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 4, name: 'Harrachov' },
                ],
              },
            ],
          }),
