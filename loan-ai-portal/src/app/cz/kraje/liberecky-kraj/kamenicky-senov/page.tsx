...
export const metadata = {
  title: 'Půjčky Kamenický Šenov, Liberecký kraj – Srovnání 2025',
  description: 'Najděte nejlepší půjčky v Kamenický Šenov. Kompletní informace o regulacích, podmínkách a licencovaných poskytovatelích v Libereckém kraji.',
}

export default function Kamenicky_senovPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <CardContent>
            <div className="bg-gray-100 p-8 rounded-lg text-center">
              <p className="text-gray-600 mb-4">
                Zde se zobrazí srovnávač nabídek od licencovaných poskytovatelů pro Kamenický Šenov
              </p>
      ...
      <section className="mb-10">
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Jaké typy půjček jsou dostupné v Kamenický Šenov?</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-700">
                V Kamenický Šenov jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace 
            ...
            '@graph': [
              {
                ...
                name: 'Půjčky v Kamenický Šenov',
                address: {
                  '@type': 'PostalAddress',
                  addressLocality: 'Kamenický Šenov',
              ...
              },
              {
                ...
                mainEntity: [
                  {
                    '@type': 'Question',
                    name: 'Jaké typy půjček jsou dostupné v Kamenický Šenov?',
                    acceptedAnswer: {
                      '@type': 'Answer',
                      text: 'V Kamenický Šenov jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace dluhů.',
                    },
                  },
                ],
              },
              {
                ...
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 4, name: 'Kamenický Šenov' },
                ],
              },
            ],
          }),
