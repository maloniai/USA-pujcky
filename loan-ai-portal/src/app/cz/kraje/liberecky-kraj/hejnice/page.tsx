...
export const metadata = {
  title: 'Půjčky Hejnice, Liberecký kraj – Srovnání 2025',
  description: 'Najděte nejlepší půjčky v Hejnice. Kompletní informace o regulacích, podmínkách a licencovaných poskytovatelích v Libereckém kraji.',
}

export default function HejnicePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <nav className="mb-6 text-sm">
        ...
        {' > '}
        <span className="text-gray-600">Hejnice</span>
      </nav>

      {/* H1 Heading */}
      <header className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Půjčky v Hejnice, Liberecký kraj</h1>
      </header>

      {/* Introduction */}
      <section className="mb-10">
        <p className="text-lg text-gray-700 leading-relaxed">
          Hejnice jsou menší město v Libereckém kraji s dostupnými finančními službami. Obyvatelé mohou využít spotřebitelské úvěry, refinancování nebo rychlé online půjčky od registrovaných poskytovatelů. Pro širší výběr se doporučuje porovnat nabídky i v okolních větších městech. Typické půjčky začínají od 5 000 Kč a mohou dosáhnout až 300 000 Kč s dobou splatnosti přizpůsobenou individuálním potřebám. Všechny produkty podléhají dozoru České národní banky.
        </p>
      </section>
          ...
          <CardContent>
            <div className="bg-gray-100 p-8 rounded-lg text-center">
              <p className="text-gray-600 mb-4">
                Zde se zobrazí srovnávač nabídek od licencovaných poskytovatelů pro Hejnice
              </p>
      ...
      <section className="mb-10">
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Jaké typy půjček jsou dostupné v Hejnice?</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-700">
                V Hejnice jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace 
            ...
            '@graph': [
              {
                ...
                name: 'Půjčky v Hejnice',
                address: {
                  '@type': 'PostalAddress',
                  addressLocality: 'Hejnice',
              ...
              },
              {
                ...
                mainEntity: [
                  {
                    '@type': 'Question',
                    name: 'Jaké typy půjček jsou dostupné v Hejnice?',
                    acceptedAnswer: {
                      '@type': 'Answer',
                      text: 'V Hejnice jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace dluhů.',
                    },
                  },
                ],
              },
              {
                ...
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 4, name: 'Hejnice' },
                ],
              },
            ],
          }),
