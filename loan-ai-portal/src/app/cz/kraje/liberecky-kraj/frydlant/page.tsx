...
export const metadata = {
  title: 'Půjčky Frýdlant, Liberecký kraj – Srovnání 2025',
  description: 'Najděte nejlepší půjčky v Frýdlant. Kompletní informace o regulacích, podmínkách a licencovaných poskytovatelích v Libereckém kraji.',
}

export default function FrydlantPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <nav className="mb-6 text-sm">
        ...
        {' > '}
        <span className="text-gray-600">Frýdlant</span>
      </nav>

      {/* H1 Heading */}
      <header className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Půjčky v Frýdlant, Liberecký kraj</h1>
      </header>
          ...
          <CardContent>
            <div className="bg-gray-100 p-8 rounded-lg text-center">
              <p className="text-gray-600 mb-4">
                Zde se zobrazí srovnávač nabídek od licencovaných poskytovatelů pro Frýdlant
              </p>
      ...
      <section className="mb-10">
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Jaké typy půjček jsou dostupné v Frýdlant?</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-700">
                V Frýdlant jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace 
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                <Link href="/cz/kraje/liberecky-kraj/hejnice" className="block text-blue-600 hover:underline">
                  Půjčky Hejnice →
                </Link>
            ...
            '@graph': [
              {
                ...
                name: 'Půjčky v Frýdlant',
                address: {
                  '@type': 'PostalAddress',
                  addressLocality: 'Frýdlant',
              ...
              },
              {
                ...
                mainEntity: [
                  {
                    '@type': 'Question',
                    name: 'Jaké typy půjček jsou dostupné v Frýdlant?',
                    acceptedAnswer: {
                      '@type': 'Answer',
                      text: 'V Frýdlant jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace dluhů.',
                    },
                  },
                ],
              },
              {
                ...
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 4, name: 'Frýdlant' },
                ],
              },
            ],
          }),
