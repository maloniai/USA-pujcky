...
export const metadata = {
  title: 'Půjčky Turnov, Liberecký kraj – Srovnání 2025',
  description: 'Najděte nejlepší půjčky v Turnov. Kompletní informace o regulacích, podmínkách a licencovaných poskytovatelích v Libereckém kraji.',
}

export default function TurnovPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <CardContent>
            <div className="bg-gray-100 p-8 rounded-lg text-center">
              <p className="text-gray-600 mb-4">
                Zde se zobrazí srovnávač nabídek od licencovaných poskytovatelů pro Turnov
              </p>
      ...
      <section className="mb-10">
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Jaké typy půjček jsou dostupné v Turnov?</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-700">
                V Turnov jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace 
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <Link href="/cz/kraje/liberecky-kraj/lomnice-nad-popelkou" className="block text-blue-600 hover:underline">
                  Půjčky Lomnice nad Popelkou →
                </Link>
                <Link href="/cz/kraje/liberecky-kraj/zelezny-brod" className="block text-blue-600 hover:underline">
                  Půjčky Železný Brod →
                </Link>
              </div>
            </CardContent>
            ...
            '@graph': [
              ...
              },
              {
                ...
                mainEntity: [
                  {
                    '@type': 'Question',
                    name: 'Jaké typy půjček jsou dostupné v Turnov?',
                    acceptedAnswer: {
                      '@type': 'Answer',
                      text: 'V Turnov jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace dluhů.',
                    },
                  },
                ],
              },
              {
                ...
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 4, name: 'Turnov' },
                ],
              },
            ],
          }),
