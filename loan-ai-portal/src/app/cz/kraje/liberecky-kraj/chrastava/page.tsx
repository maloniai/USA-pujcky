...
export const metadata = {
  title: 'Půjčky Chrastava, Liberecký kraj – Srovnání 2025',
  description: 'Najděte nejlepší půjčky v Chrastava. Kompletní informace o regulacích, podmínkách a licencovaných poskytovatelích v Libereckém kraji.',
}

export default function ChrastavaPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <nav className="mb-6 text-sm">
        ...
        {' > '}
        <span className="text-gray-600">Chrastava</span>
      </nav>

      {/* H1 Heading */}
      <header className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Půjčky v Chrastava, Liberecký kraj</h1>
      </header>

      {/* Introduction */}
      <section className="mb-10">
        <p className="text-lg text-gray-700 leading-relaxed">
          Chrastava je město v Libereckém kraji s rozvinutými finančními službami díky blízkosti Liberce. Obyvatelé mají přístup k široké nabídce spotřebitelských úvěrů, refinancování, půjček na bydlení i rychlých online půjček. Konkurenční prostředí zajišťuje atraktivní podmínky. Typické půjčky se pohybují od 5 000 do 800 000 Kč s flexibilní dobou splatnosti. Všechny produkty podléhají regulaci ČNB, což garantuje transparentnost, férové podmínky a právo na předčasné splacení.
        </p>
      </section>
          ...
          <CardContent>
            <div className="bg-gray-100 p-8 rounded-lg text-center">
              <p className="text-gray-600 mb-4">
                Zde se zobrazí srovnávač nabídek od licencovaných poskytovatelů pro Chrastava
              </p>
      ...
      <section className="mb-10">
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Jaké typy půjček jsou dostupné v Chrastava?</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-700">
                V Chrastava jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace 
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <Link href="/cz/kraje/liberecky-kraj/hradek-nad-nisou" className="block text-blue-600 hover:underline">
                  Půjčky Hrádek nad Nisou →
                </Link>
            ...
            '@graph': [
              {
                ...
                name: 'Půjčky v Chrastava',
                address: {
                  '@type': 'PostalAddress',
                  addressLocality: 'Chrastava',
              ...
              },
              {
                ...
                mainEntity: [
                  {
                    '@type': 'Question',
                    name: 'Jaké typy půjček jsou dostupné v Chrastava?',
                    acceptedAnswer: {
                      '@type': 'Answer',
                      text: 'V Chrastava jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace dluhů.',
                    },
                  },
                ],
              },
              {
                ...
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 4, name: 'Chrastava' },
                ],
              },
            ],
          }),
