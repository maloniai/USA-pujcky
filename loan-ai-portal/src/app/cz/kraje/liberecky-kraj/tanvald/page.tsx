...
export const metadata = {
  title: 'Půjčky Tanvald, Liberecký kraj – Srovnání 2025',
  description: 'Najděte nejlepší půjčky v Tanvald. Kompletní informace o regulacích, podmínkách a licencovaných poskytovatelích v Libereckém kraji.',
}

export default function TanvaldPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <CardContent>
            <div className="bg-gray-100 p-8 rounded-lg text-center">
              <p className="text-gray-600 mb-4">
                Zde se zobrazí srovnávač nabídek od licencovaných poskytovatelů pro Tanvald
              </p>
      ...
      <section className="mb-10">
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Jaké typy půjček jsou dostupné v Tanvald?</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-700">
                V Tanvald jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace 
            ...
            '@graph': [
              ...
              },
              {
                ...
                mainEntity: [
                  {
                    '@type': 'Question',
                    name: 'Jaké typy půjček jsou dostupné v Tanvald?',
                    acceptedAnswer: {
                      '@type': 'Answer',
                      text: 'V Tanvald jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace dluhů.',
                    },
                  },
                ],
              },
              {
                ...
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 4, name: 'Tanvald' },
                ],
              },
            ],
          }),
