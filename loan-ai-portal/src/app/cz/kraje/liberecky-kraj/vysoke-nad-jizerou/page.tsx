...
export const metadata = {
  title: 'Půjčky Vysoké nad Jizerou, Liberecký kraj – Srovnání 2025',
  description: 'Najděte nejlepší půjčky v Vysoké nad Jizerou. Kompletní informace o regulacích, podmínkách a licencovaných poskytovatelích v Libereckém kraji.',
}

export default function Vysoke_nad_jizerouPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <CardContent>
            <div className="bg-gray-100 p-8 rounded-lg text-center">
              <p className="text-gray-600 mb-4">
                Zde se zobrazí srovnávač nabídek od licencovaných poskytovatelů pro Vysoké nad Jizerou
              </p>
      ...
      <section className="mb-10">
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Jaké typy půjček jsou dostupné v Vysoké nad Jizerou?</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-700">
                V Vysoké nad Jizerou jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace 
            ...
            '@graph': [
              {
                ...
                name: 'Půjčky v Vysoké nad Jizerou',
                address: {
                  '@type': 'PostalAddress',
              ...
              },
              {
                ...
                mainEntity: [
                  {
                    '@type': 'Question',
                    name: 'Jaké typy půjček jsou dostupné v Vysoké nad Jizerou?',
                    acceptedAnswer: {
                      '@type': 'Answer',
                      text: 'V Vysoké nad Jizerou jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace dluhů.',
                    },
                  },
                ],
              },
              {
                ...
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 4, name: 'Vysoké nad Jizerou' },
                ],
              },
            ],
          }),
