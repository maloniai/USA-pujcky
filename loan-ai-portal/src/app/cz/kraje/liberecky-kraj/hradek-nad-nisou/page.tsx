...
export const metadata = {
  title: 'Půjčky Hrádek nad Nisou, Liberecký kraj – Srovnání 2025',
  description: 'Najděte nejlepší půjčky v Hrádek nad Nisou. Kompletní informace o regulacích, podmínkách a licencovaných poskytovatelích v Libereckém kraji.',
}

export default function Hradek_nad_nisouPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <CardContent>
            <div className="bg-gray-100 p-8 rounded-lg text-center">
              <p className="text-gray-600 mb-4">
                Zde se zobrazí srovnávač nabídek od licencovaných poskytovatelů pro Hrádek nad Nisou
              </p>
      ...
      <section className="mb-10">
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Jaké typy půjček jsou dostupné v Hrádek nad Nisou?</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-700">
                V Hrádek nad Nisou jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace 
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                <Link href="/cz/kraje/liberecky-kraj/frydlant" className="block text-blue-600 hover:underline">
                  Půjčky Frýdlant →
                </Link>
                <Link href="/cz/kraje/liberecky-kraj/chrastava" className="block text-blue-600 hover:underline">
                  Půjčky Chrastava →
                </Link>
            ...
            '@graph': [
              {
                ...
                name: 'Půjčky v Hrádek nad Nisou',
                address: {
                  '@type': 'PostalAddress',
                  addressLocality: 'Hrádek nad Nisou',
              ...
              },
              {
                ...
                mainEntity: [
                  {
                    '@type': 'Question',
                    name: 'Jaké typy půjček jsou dostupné v Hrádek nad Nisou?',
                    acceptedAnswer: {
                      '@type': 'Answer',
                      text: 'V Hrádek nad Nisou jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace dluhů.',
                    },
                  },
                ],
              },
              {
                ...
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 4, name: 'Hrádek nad Nisou' },
                ],
              },
            ],
          }),
