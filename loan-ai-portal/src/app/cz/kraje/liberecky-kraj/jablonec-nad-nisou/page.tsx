...
export const metadata = {
  title: 'Půjčky Jablonec nad Nisou, Liberecký kraj – Srovnání 2025',
  description: 'Najděte nejlepší půjčky v Jablonec nad Nisou. Kompletní informace o regulacích, podmínkách a licencovaných poskytovatelích v Libereckém kraji.',
}

export default function Jablonec_nad_nisouPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <CardContent>
            <div className="bg-gray-100 p-8 rounded-lg text-center">
              <p className="text-gray-600 mb-4">
                Zde se zobrazí srovnávač nabídek od licencovaných poskytovatelů pro Jablonec nad Nisou
              </p>
      ...
      <section className="mb-10">
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Jaké typy půjček jsou dostupné v Jablonec nad Nisou?</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-700">
                V Jablonec nad Nisou jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace 
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                <Link href="/cz/kraje/liberecky-kraj/liberec" className="block text-blue-600 hover:underline">
                  Půjčky Liberec →
                </Link>
                <Link href="/cz/kraje/liberecky-kraj/tanvald" className="block text-blue-600 hover:underline">
                  Půjčky Tanvald →
                </Link>
                <Link href="/cz/kraje/liberecky-kraj/smrzovka" className="block text-blue-600 hover:underline">
                  Půjčky Smržovka →
                </Link>
              </div>
            </CardContent>
            ...
            '@graph': [
              {
                ...
                name: 'Půjčky v Jablonec nad Nisou',
                address: {
                  '@type': 'PostalAddress',
              ...
              },
              {
                ...
                mainEntity: [
                  {
                    '@type': 'Question',
                    name: 'Jaké typy půjček jsou dostupné v Jablonec nad Nisou?',
                    acceptedAnswer: {
                      '@type': 'Answer',
                      text: 'V Jablonec nad Nisou jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace dluhů.',
                    },
                  },
                ],
              },
              {
                ...
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 4, name: 'Jablonec nad Nisou' },
                ],
              },
            ],
          }),
