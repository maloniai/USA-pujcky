...
export const metadata = {
  title: 'Půjčky Nový Bor, Liberecký kraj – Srovnání 2025',
  description: 'Najděte nejlepší půjčky v Nový Bor. Kompletní informace o regulacích, podmínkách a licencovaných poskytovatelích v Libereckém kraji.',
}

export default function Novy_borPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <nav className="mb-6 text-sm">
        ...
        {' > '}
        <span className="text-gray-600">Nový Bor</span>
      </nav>

      {/* H1 Heading */}
      <header className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Půjčky v Nový Bor, Liberecký kraj</h1>
      </header>

      {/* Introduction */}
      <section className="mb-10">
        <p className="text-lg text-gray-700 leading-relaxed">
          Nový Bor je město v Libereckém kraji se silnou tradicí ve sklářství a rozvinutými finančními službami. Nabízí širokou škálu spotřebitelských úvěrů, refinancování, půjček pro podnikatele i rychlé online půjčky. Konkurenční prostředí zajišťuje atraktivní podmínky. Typické částky se pohybují od 10 000 do 700 000 Kč. Všichni poskytovatelé musí dodržovat českou legislativu včetně registrace u ČNB, limitů RPSN a 14denního práva na odstoupení od smlouvy.
        </p>
      </section>
          ...
          <CardContent>
            <div className="bg-gray-100 p-8 rounded-lg text-center">
              <p className="text-gray-600 mb-4">
                Zde se zobrazí srovnávač nabídek od licencovaných poskytovatelů pro Nový Bor
              </p>
      ...
      <section className="mb-10">
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Jaké typy půjček jsou dostupné v Nový Bor?</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-700">
                V Nový Bor jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace 
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <Link href="/cz/kraje/liberecky-kraj/kamenicky-senov" className="block text-blue-600 hover:underline">
                  Půjčky Kamenický Šenov →
                </Link>
            ...
            '@graph': [
              ...
              },
              {
                ...
                mainEntity: [
                  {
                    '@type': 'Question',
                    name: 'Jaké typy půjček jsou dostupné v Nový Bor?',
                    acceptedAnswer: {
                      '@type': 'Answer',
                      text: 'V Nový Bor jsou dostupné spotřebitelské úvěry, rychlé půjčky, refinancování a konsolidace dluhů.',
                    },
                  },
                ],
              },
              {
                ...
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 4, name: 'Nový Bor' },
                ],
              },
            ],
          }),
