...
export const metadata = {
  title: 'Půjčky v Česká Třebová, Pardubický kraj – Porovnejte 2025',
  description: 'Najděte nejlepší půjčky v Česká Třebová. Srovnání nabídek od licencovaných poskytovatelů, místní regulace a rychlé schválení online.',
}

export default function ceska_trebovaPage() {
  const nearbyCities = [
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <h1 className="text-4xl font-bold mb-6">Půjčky v Česká Třebová, Pardubický kraj</h1>
      
      <div className="prose max-w-none mb-8">
        <p className="text-lg text-gray-700 leading-relaxed">
          Česká Třebová nabízí obyvatelům různé možnosti půjček od licencovaných poskytovatelů. 
          Ať už hledáte rychlou spotřebitelskou půjčku, refinancování stávajícího úvěru, 
          nebo dlouhodobější financování, v Česká Třebová najdete konkurenceschopné nabídky. 
      ...
      <div className="bg-white border rounded-lg p-6 mb-8">
        <h2 className="text-2xl font-semibold mb-4">Nabídky Půjček v Česká Třebová</h2>
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-semibold text-gray-900 mb-2">
              Jaké dokumenty potřebuji pro žádost o půjčku v Česká Třebová?
            </h3>
          ...
          <div>
            <h3 className="font-semibold text-gray-900 mb-2">
              Mohu získat půjčku v Česká Třebová s negativním záznamem v registru?
            </h3>
            <p className="text-gray-700">
          ...
          <div>
            <h3 className="font-semibold text-gray-900 mb-2">
              Jaké jsou typické úrokové sazby pro půjčky v Česká Třebová?
            </h3>
            <p className="text-gray-700">
