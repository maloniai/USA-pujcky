...
export const metadata = {
  title: 'Půjčky v Pardubicích, Pardubický kraj – Porovnejte 2025',
  description: 'Najděte nejlepší půjčky v Pardubicích. Srovnání nabídek od licencovaných poskytovatelů, místní regulace a rychlé schválení online.',
}

export default function PardubicePage() {
  const nearbyCities = [
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <h1 className="text-4xl font-bold mb-6">Půjčky v Pardubicích, Pardubický kraj</h1>
      
      <div className="prose max-w-none mb-8">
        <p className="text-lg text-gray-700 leading-relaxed">
          Pardubice, krajské město Pardubického kraje, nabízí širokou škálu možností půjček 
          pro místní obyvatele i podnikatele. Ať už hledáte rychlou spotřebitelskou půjčku, 
          hypotéku na bydlení, nebo financování pro podnikání, v Pardubicích najdete různé 
          licencované poskytovatele s konkurenceschopnými podmínkami. Většina bank a finančních 
          institucí v městě nabízí online žádosti s rychlým vyřízením během 24-48 hodin. 
          Typické úrokové sazby se pohybují mezi 6-18% RPSN v závislosti na typu půjčky a 
          vaší bonitě. Pardubice jako krajské město má silnou ekonomiku založenou na průmyslu, 
          obchodu a službách, což poskytuje stabilní prostředí pro finanční služby.
        </p>
      </div>

      <div className="bg-white border rounded-lg p-6 mb-8">
        <h2 className="text-2xl font-semibold mb-4">Nabídky Půjček v Pardubicích</h2>
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-semibold text-gray-900 mb-2">
              Jaké dokumenty potřebuji pro žádost o půjčku v Pardubicích?
            </h3>
          ...
          <div>
            <h3 className="font-semibold text-gray-900 mb-2">
              Mohu získat půjčku v Pardubicích s negativním záznamem v registru?
            </h3>
            <p className="text-gray-700">
          ...
          <div>
            <h3 className="font-semibold text-gray-900 mb-2">
              Jaké jsou výhody online půjček oproti tradičním bankám v Pardubicích?
            </h3>
            <p className="text-gray-700">
              Online půjčky nabízejí rychlejší schválení, méně papírování, dostupnost 24/7 
              a často jednodušší proces. Tradiční banky však mohou nabídnout nižší úrokové 
              sazby a větší flexibilitu pro dlouhodobé financování nebo větší částky.
            </p>
          </div>
        </div>
      </div>
