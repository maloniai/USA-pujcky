...
export const metadata = {
  title: 'Půjčky Havlíčkův Brod, Kraj Vysočina – Srovnání 2025',
  description: 'Hledáte půjčku v Havlíčkův Brod? Porovnejte nejlepší nabídky online půjček od licencovaných poskytovatelů. Rychlé schválení, výhodné podmínky.',
}

export default function havlickuvbrodPage() {
  const nearbyCities = [
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8 text-sm">
        ...
        {' > '}
        <span className="text-gray-600">Havlíčkův Brod</span>
      </div>

      {/* H1 Title */}
      <h1 className="text-4xl font-bold mb-6">Půjčky v Havlíčkův Brod, Kraj Vysočina</h1>

      {/* Intro paragraph */}
      <div className="prose max-w-none mb-8">
        <p className="text-lg text-gray-700 leading-relaxed">
          V Havlíčkově Brodě nabízíme komplexní informace o půjčkách pro občany města i okolí. Dostupné jsou bankovní i nebankovní produkty, včetně konsolidačních úvěrů pro sjednocení více závazků. Všechny nabídky musí respektovat české zákony o ochraně spotřebitele a transparentnosti úvěrových podmínek. Běžné půjčky začínají na 5 000 Kč a mohou dosáhnout až 500 000 Kč při odpovídající úvěruschopnosti.
        </p>
      </div>
      ...
      <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-8 mb-8 text-center">
        ...
        <p className="text-gray-600 mb-4">
          Zde bude zobrazeno porovnání nabídek od ověřených poskytovatelů pro Havlíčkův Brod
        </p>
        <div className="bg-white rounded p-6 min-h-[300px] flex items-center justify-center">
          <p className="text-gray-500 italic">[Iframe s nabídkami půjček pro Havlíčkův Brod]</p>
        </div>
      </div>
      ...
      {/* FAQ Section */}
      <div className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Často kladené otázky o půjčkách v Havlíčkův Brod</h2>
        <div className="space-y-4">
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-2">Jaké jsou požadavky pro získání půjčky v Havlíčkův Brod?</h3>
          ...
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-2">Jak dlouho trvá schválení půjčky v Havlíčkův Brod?</h3>
            <p className="text-gray-700">
          ...
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-2">Jsou online půjčky v Havlíčkův Brod bezpečné?</h3>
            <p className="text-gray-700">
