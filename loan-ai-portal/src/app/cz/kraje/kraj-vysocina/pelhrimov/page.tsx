...
export const metadata = {
  title: 'Půjčky Pelhřimov, Kraj Vysočina – Srovnání 2025',
  description: 'Hledáte půjčku v Pelhřimov? Porovnejte nejlepší nabídky online půjček od licencovaných poskytovatelů. Rychlé schválení, výhodné podmínky.',
}

export default function pelhrimovPage() {
  const nearbyCities = [
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8 text-sm">
        ...
        {' > '}
        <span className="text-gray-600">Pelhřimov</span>
      </div>

      {/* H1 Title */}
      <h1 className="text-4xl font-bold mb-6">Půjčky v Pelhřimov, Kraj Vysočina</h1>

      {/* Intro paragraph */}
      <div className="prose max-w-none mb-8">
        <p className="text-lg text-gray-700 leading-relaxed">
          Pelhřimov nabízí obyvatelům širokou paletu úvěrových produktů od licencovaných poskytovatelů. Od rychlých online půjček po klasické spotřebitelské úvěry – vše podléhá dohledu České národní banky. Poskytovatele lze ověřit v registru ČNB, což zajišťuje bezpečnost a férové podmínky. Standardní rozsah půjček je 5 000 – 400 000 Kč se splatností 6 měsíců až 7 let podle typu produktu.
        </p>
      </div>
      ...
      <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-8 mb-8 text-center">
        ...
        <p className="text-gray-600 mb-4">
          Zde bude zobrazeno porovnání nabídek od ověřených poskytovatelů pro Pelhřimov
        </p>
        <div className="bg-white rounded p-6 min-h-[300px] flex items-center justify-center">
          <p className="text-gray-500 italic">[Iframe s nabídkami půjček pro Pelhřimov]</p>
        </div>
      </div>
      ...
      {/* FAQ Section */}
      <div className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Často kladené otázky o půjčkách v Pelhřimov</h2>
        <div className="space-y-4">
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-2">Jaké jsou požadavky pro získání půjčky v Pelhřimov?</h3>
          ...
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-2">Jak dlouho trvá schválení půjčky v Pelhřimov?</h3>
            <p className="text-gray-700">
          ...
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-2">Jsou online půjčky v Pelhřimov bezpečné?</h3>
            <p className="text-gray-700">
