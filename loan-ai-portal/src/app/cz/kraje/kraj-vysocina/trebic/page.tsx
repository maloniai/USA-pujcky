...
export const metadata = {
  title: 'Půjčky Třebíč, Kraj Vysočina – Srovnání 2025',
  description: 'Hledáte půjčku v Třebíč? Porovnejte nejlepší nabídky online půjček od licencovaných poskytovatelů. Rychlé schválení, výhodné podmínky.',
}

export default function trebicPage() {
  const nearbyCities = [
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8 text-sm">
        ...
        {' > '}
        <span className="text-gray-600">Třebíč</span>
      </div>

      {/* H1 Title */}
      <h1 className="text-4xl font-bold mb-6">Půjčky v Třebíč, Kraj Vysočina</h1>

      {/* Intro paragraph */}
      <div className="prose max-w-none mb-8">
        <p className="text-lg text-gray-700 leading-relaxed">
          Třebíč je významným městem na Vysočině s bohatou historií. Nabízíme přehled všech typů půjček dostupných místním obyvatelům – od hotovostních půjček až po účelové úvěry na bydlení. České předpisy vyžadují, aby každý poskytovatel transparentně informoval o RPSN a všech poplatcích. Typické částky se pohybují mezi 10 000 Kč a 300 000 Kč, přičemž doba splatnosti může být od 3 měsíců do 5 let.
        </p>
      </div>
      ...
      <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-8 mb-8 text-center">
        ...
        <p className="text-gray-600 mb-4">
          Zde bude zobrazeno porovnání nabídek od ověřených poskytovatelů pro Třebíč
        </p>
        <div className="bg-white rounded p-6 min-h-[300px] flex items-center justify-center">
          <p className="text-gray-500 italic">[Iframe s nabídkami půjček pro Třebíč]</p>
        </div>
      </div>
      ...
      {/* FAQ Section */}
      <div className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Často kladené otázky o půjčkách v Třebíč</h2>
        <div className="space-y-4">
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-2">Jaké jsou požadavky pro získání půjčky v Třebíč?</h3>
          ...
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-2">Jak dlouho trvá schválení půjčky v Třebíč?</h3>
            <p className="text-gray-700">
          ...
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-2">Jsou online půjčky v Třebíč bezpečné?</h3>
            <p className="text-gray-700">
