...
export const metadata = {
  title: 'Půjčky Telč, Kraj Vysočina – Srovnání 2025',
  description: 'Hledáte půjčku v Telč? Porovnejte nejlepší nabídky online půjček od licencovaných poskytovatelů. Rychlé schválení, výhodné podmínky.',
}
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8 text-sm">
        ...
        {' > '}
        <span className="text-gray-600">Telč</span>
      </div>

      {/* H1 Title */}
      <h1 className="text-4xl font-bold mb-6">Půjčky v Telč, Kraj Vysočina</h1>

      {/* Intro paragraph */}
      <div className="prose max-w-none mb-8">
        <p className="text-lg text-gray-700 leading-relaxed">
          V Telči, malebném městě na Vysočině, je k dispozici řada možností financování pro místní obyvatele i návštěvníky regionu. Od osobních půjček po úvěry na dovolenou – každý produkt musí splňovat přísné české normy. Poskytovatele je možné ověřit prostřednictvím registru ČNB. Typické půjčky se pohybují od 5 000 Kč do 200 000 Kč se splatností 6 měsíců až 5 let.
        </p>
      </div>
      ...
      <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-8 mb-8 text-center">
        ...
        <p className="text-gray-600 mb-4">
          Zde bude zobrazeno porovnání nabídek od ověřených poskytovatelů pro Telč
        </p>
        <div className="bg-white rounded p-6 min-h-[300px] flex items-center justify-center">
          <p className="text-gray-500 italic">[Iframe s nabídkami půjček pro Telč]</p>
        </div>
      </div>
      ...
      {/* FAQ Section */}
      <div className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Často kladené otázky o půjčkách v Telč</h2>
        <div className="space-y-4">
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-2">Jaké jsou požadavky pro získání půjčky v Telč?</h3>
          ...
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-2">Jak dlouho trvá schválení půjčky v Telč?</h3>
            <p className="text-gray-700">
          ...
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-2">Jsou online půjčky v Telč bezpečné?</h3>
            <p className="text-gray-700">
