...
export const metadata = {
  title: 'Půjčky Počátky, Kraj Vysočina – Srovnání 2025',
  description: 'Hledáte půjčku v Počátky? Porovnejte nejlepší nabídky online půjček od licencovaných poskytovatelů. Rychlé schválení, výhodné podmínky.',
}

export default function pocatkyPage() {
  const nearbyCities = [
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8 text-sm">
        ...
        {' > '}
        <span className="text-gray-600">Počátky</span>
      </div>

      <h1 className="text-4xl font-bold mb-6">Půjčky v Počátky, Kraj Vysočina</h1>

      <div className="prose max-w-none mb-8">
        <p className="text-lg text-gray-700 leading-relaxed">
          V Počátkách mohou občané využít širokou nabídku úvěrových možností od licencovaných poskytovatelů. České zákony zajišťují férové podmínky a právo na odstoupení od smlouvy. Typické půjčky začínají na 5 000 Kč a mohou dosáhnout 200 000 Kč.
        </p>
      </div>
      ...
      <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-8 mb-8 text-center">
        ...
        <p className="text-gray-600 mb-4">
          Zde bude zobrazeno porovnání nabídek od ověřených poskytovatelů pro Počátky
        </p>
        <div className="bg-white rounded p-6 min-h-[300px] flex items-center justify-center">
          <p className="text-gray-500 italic">[Iframe s nabídkami půjček pro Počátky]</p>
        </div>
      </div>
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Často kladené otázky o půjčkách v Počátky</h2>
        <div className="space-y-4">
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-2">Jaké jsou požadavky pro získání půjčky v Počátky?</h3>
          ...
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-2">Jak dlouho trvá schválení půjčky v Počátky?</h3>
            <p className="text-gray-700">
          ...
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-2">Jsou online půjčky v Počátky bezpečné?</h3>
            <p className="text-gray-700">
