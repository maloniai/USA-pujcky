...
export const metadata = {
  title: 'Půjčky Jihlava, Kraj Vysočina – Srovnání 2025',
  description: 'Hledáte půjčku v Jihlavě? Porovnejte nejlepší nabídky online půjček od licencovaných poskytovatelů. Rychlé schválení, výhodné podmínky.',
}

export default function JihlavaPage() {
  const nearbyCities = [
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8 text-sm">
        ...
        {' > '}
        <span className="text-gray-600">Jihlava</span>
      </div>

      {/* H1 Title */}
      <h1 className="text-4xl font-bold mb-6">Půjčky v Jihlavě, Kraj Vysočina</h1>

      {/* Intro paragraph */}
      <div className="prose max-w-none mb-8">
        <p className="text-lg text-gray-700 leading-relaxed">
          V Jihlavě, krajském městě Vysočiny, nabízíme komplexní přehled možností financování. Můžete si vybrat 
          z široké škály produktů – od klasických spotřebitelských úvěrů přes konsolidace až po rychlé online půjčky. 
          Regulace ze strany České národní banky zajišťuje, že všechny licencované subjekty dodržují transparentní 
          informační povinnosti a férové podmínky. Typické půjčky se pohybují od 5 000 Kč do 500 000 Kč s dobou 
          splatnosti 6 měsíců až 7 let, přičemž konkrétní podmínky závisí na individuálním hodnocení klienta.
        </p>
      </div>
      ...
      <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-8 mb-8 text-center">
        ...
        <p className="text-gray-600 mb-4">
          Zde bude zobrazeno porovnání nabídek od ověřených poskytovatelů pro Jihlavu
        </p>
        <div className="bg-white rounded p-6 min-h-[300px] flex items-center justify-center">
          <p className="text-gray-500 italic">[Iframe s nabídkami půjček pro Jihlavu]</p>
        </div>
      </div>
      ...
      {/* FAQ Section */}
      <div className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Často kladené otázky o půjčkách v Jihlavě</h2>
        <div className="space-y-4">
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-2">Jaké jsou požadavky pro získání půjčky v Jihlavě?</h3>
          ...
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-2">Jak dlouho trvá schválení půjčky v Jihlavě?</h3>
            <p className="text-gray-700">
          ...
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-2">Jsou online půjčky v Jihlavě bezpečné?</h3>
            <p className="text-gray-700">
