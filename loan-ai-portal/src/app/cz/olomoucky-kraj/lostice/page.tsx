...
export const metadata = {
  title: 'Půjčky v Loštice, Olomoucký kraj – Porovnat 2025',
  description: 'Hledáte půjčku v Loštice? Porovnejte nabídky online půjček, zjistěte místní podmínky a najděte důvěryhodné poskytovatele ve vašem městě.',
}

export default function LosticePage() {
  const nearbyCities = [
    {
        "name": "Litovel",
        "slug": "litovel"
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <nav className="text-sm mb-6 text-gray-600">
        ...
        {' > '}
        <span className="text-gray-900">Loštice</span>
      </nav>

      {/* Header */}
      <header className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          Půjčky v Loštice, Olomoucký kraj
        </h1>
        <div className="prose max-w-none">
          <p className="text-lg text-gray-700 leading-relaxed">
            Loštice nabízí přístup k širokému spektru finančních služeb včetně spotřebitelských 
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-4">Aktuální Nabídky Půjček v Loštice</h2>
        <div className="bg-white p-6 border rounded-lg">
          <p className="text-gray-700 mb-4">
            Porovnejte nabídky od důvěryhodných poskytovatelů působících v Loštice. 
          ...
          <div className="bg-gray-100 p-8 rounded border-2 border-dashed border-gray-300 text-center">
            <p className="text-gray-500">
              [Místo pro iframe s nabídkami důvěryhodných poskytovatelů pro Loštice]
            </p>
            <p className="text-sm text-gray-400 mt-2">
              Zde se zobrazí aktuální nabídky specifické pro Loštice
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="font-semibold text-lg mb-2">
              Jaké typy půjček jsou dostupné v Loštice?
            </h3>
            <p className="text-gray-700">
              V Loštice můžete získat spotřebitelské úvěry, konsolidační půjčky, rychlé 
          ...
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="font-semibold text-lg mb-2">
              Jak rychle mohu získat půjčku v Loštice?
            </h3>
            <p className="text-gray-700">
