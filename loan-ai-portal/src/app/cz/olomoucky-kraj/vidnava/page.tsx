...
export const metadata = {
  title: 'Půjčky v Vidnava, Olomoucký kraj – Porovnat 2025',
  description: 'Hledáte půjčku v Vidnava? Porovnejte nabídky online půjček, zjistěte místní podmínky a najděte důvěryhodné poskytovatele ve vašem městě.',
}

export default function VidnavaPage() {
  const nearbyCities = [
    {
        "name": "Jeseník",
        "slug": "jesenik"
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <nav className="text-sm mb-6 text-gray-600">
        ...
        {' > '}
        <span className="text-gray-900">Vidnava</span>
      </nav>

      {/* Header */}
      <header className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          Půjčky v Vidnava, Olomoucký kraj
        </h1>
        <div className="prose max-w-none">
          <p className="text-lg text-gray-700 leading-relaxed">
            Vidnava nabízí přístup k širokému spektru finančních služeb včetně spotřebitelských 
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-4">Aktuální Nabídky Půjček v Vidnava</h2>
        <div className="bg-white p-6 border rounded-lg">
          <p className="text-gray-700 mb-4">
            Porovnejte nabídky od důvěryhodných poskytovatelů působících v Vidnava. 
          ...
          <div className="bg-gray-100 p-8 rounded border-2 border-dashed border-gray-300 text-center">
            <p className="text-gray-500">
              [Místo pro iframe s nabídkami důvěryhodných poskytovatelů pro Vidnava]
            </p>
            <p className="text-sm text-gray-400 mt-2">
              Zde se zobrazí aktuální nabídky specifické pro Vidnava
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="font-semibold text-lg mb-2">
              Jaké typy půjček jsou dostupné v Vidnava?
            </h3>
            <p className="text-gray-700">
              V Vidnava můžete získat spotřebitelské úvěry, konsolidační půjčky, rychlé 
          ...
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="font-semibold text-lg mb-2">
              Jak rychle mohu získat půjčku v Vidnava?
            </h3>
            <p className="text-gray-700">
