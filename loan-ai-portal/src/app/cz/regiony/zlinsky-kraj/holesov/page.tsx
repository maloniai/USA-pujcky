...
export const metadata = {
  title: 'Půjčky v Holešově, Zlínský kraj – Porovnejte 2025',
  description: 'Najděte nejlepší půjčky v Holešově. Porovnejte nabídky od licencovaných věřitelů, podívejte se na místní regulace a získejte rychlé schválení.',
}

export default function HolešovPage() {
  const nearbyCities = [
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <nav className="text-sm text-gray-600 mb-6">
        ...
        {' > '}
        <span className="text-gray-900">Holešov</span>
      </nav>

      <h1 className="text-4xl font-bold mb-6">Půjčky v Holešově, Zlínský kraj</h1>

      <div className="prose max-w-none mb-8">
        <p className="text-lg text-gray-700 leading-relaxed">
          V Holešově si můžete vybrat z široké nabídky půjček od licencovaných poskytovatelů. 
        ...
        <p className="text-lg text-gray-700 leading-relaxed">
          ...
          z pohodlí vašeho domova v Holešově a najít tu nejvhodnější půjčku pro vaše potřeby.
        </p>
      </div>

      <div className="bg-white border rounded-lg p-6 mb-8 shadow-sm">
        <h2 className="text-2xl font-semibold mb-4">Nabídky Půjček v Holešově</h2>
        <div className="bg-gray-50 border rounded p-4 mb-4">
          <p className="text-center text-gray-600">
            [Zde bude iframe s nabídkami od důvěryhodných partnerů pro region Holešov]
          </p>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          <div className="bg-white border rounded-lg p-4">
            <h3 className="font-semibold text-lg mb-2">Jaké jsou požadavky na získání půjčky v Holešově?</h3>
