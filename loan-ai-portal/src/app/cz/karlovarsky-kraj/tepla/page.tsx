...
export const metadata = {
  title: 'Půjčky v Teplá, Karlovarský kraj – Porovnání 2025',
  description: 'Hledáte rychlou půjčku v Teplé? Porovnejte nabídky nebankovních půjček s transparentními podmínkami. Schválení online do 24 hodin.',
}

export default function TeplaPage() {
  const nearbyCities = [
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <nav className="mb-6 text-sm text-gray-600">
        ...
        <span className="mx-2">/</span>
        <span className="text-gray-900">Teplá</span>
      </nav>

      {/* H1 Header */}
      <header className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          Půjčky v Teplé, Karlovarský kraj
        </h1>
      </header>
      ...
      <section className="mb-8 prose max-w-none">
        <p className="text-lg text-gray-700 leading-relaxed">
          V Teplé máte přístup k širokému spektru nebankovních půjček, od krátkodobých 
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 text-center min-h-[400px] flex items-center justify-center">
          <div>
            <p className="text-gray-700 mb-4">
              <strong>Porovnání nabídek pro Teplá</strong>
            </p>
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">
              Jaké dokumenty potřebuji k žádosti o půjčku v Teplé?
            </h3>
            <p className="text-gray-700">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">
              Jak dlouho trvá schválení půjčky v Teplé?
            </h3>
            <p className="text-gray-700">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">
              Mohu získat půjčku v Teplé se záporným záznamem v registru?
            </h3>
            <p className="text-gray-700">
            ...
            '@graph': [
              {
                ...
                itemListElement: [
                  ...
                  },
                  {
                    ...
                    position: 3,
                    name: 'Teplá',
                    item: 'https://www.example.com/cz/karlovarsky-kraj/tepla'
                  }
                ]
              },
              {
                ...
                name: 'Půjčky v Teplé',
                description: 'Porovnání půjček v Teplé, Karlovarský kraj',
                areaServed: {
                  '@type': 'City',
                  name: 'Teplá',
                  containedInPlace: {
              ...
              },
              {
                ...
                mainEntity: [
                  {
                    '@type': 'Question',
                    name: 'Jaké dokumenty potřebuji k žádosti o půjčku v Teplé?',
                    acceptedAnswer: {
                      '@type': 'Answer',
                  ...
                  {
                    '@type': 'Question',
                    name: 'Jak dlouho trvá schválení půjčky v Teplé?',
                    acceptedAnswer: {
                      '@type': 'Answer',
                  ...
                  {
                    '@type': 'Question',
                    name: 'Mohu získat půjčku v Teplé se záporným záznamem v registru?',
                    acceptedAnswer: {
                      '@type': 'Answer',
                ...
                itemListElement: [
                  {
                    ...
                    itemOffered: {
                      ...
                      description: 'Rychlé nebankovní půjčky pro obyvatele Teplá'
                    }
                  }
                ]
              }
