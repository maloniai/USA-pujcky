...
export const metadata = {
  title: 'Půjčky v Habartov, Karlovarský kraj – Porovnání 2025',
  description: 'Hledáte rychlou půjčku v Habartově? Porovnejte nabídky nebankovních půjček s transparentními podmínkami. Schválení online do 24 hodin.',
}

export default function HabartovPage() {
  const nearbyCities = [
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <nav className="mb-6 text-sm text-gray-600">
        ...
        <span className="mx-2">/</span>
        <span className="text-gray-900">Habartov</span>
      </nav>

      {/* H1 Header */}
      <header className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          Půjčky v Habartově, Karlovarský kraj
        </h1>
      </header>
      ...
      <section className="mb-8 prose max-w-none">
        <p className="text-lg text-gray-700 leading-relaxed">
          V Habartově máte přístup k širokému spektru nebankovních půjček, od krátkodobých 
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 text-center min-h-[400px] flex items-center justify-center">
          <div>
            <p className="text-gray-700 mb-4">
              <strong>Porovnání nabídek pro Habartov</strong>
            </p>
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">
              Jaké dokumenty potřebuji k žádosti o půjčku v Habartově?
            </h3>
            <p className="text-gray-700">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">
              Jak dlouho trvá schválení půjčky v Habartově?
            </h3>
            <p className="text-gray-700">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">
              Mohu získat půjčku v Habartově se záporným záznamem v registru?
            </h3>
            <p className="text-gray-700">
            ...
            '@graph': [
              {
                ...
                itemListElement: [
                  ...
                  },
                  {
                    ...
                    position: 3,
                    name: 'Habartov',
                    item: 'https://www.example.com/cz/karlovarsky-kraj/habartov'
                  }
                ]
              },
              {
                '@type': 'FinancialService',
                name: 'Půjčky v Habartově',
                description: 'Porovnání půjček v Habartově, Karlovarský kraj',
                areaServed: {
                  '@type': 'City',
                  name: 'Habartov',
                  containedInPlace: {
              ...
              },
              {
                ...
                mainEntity: [
                  {
                    '@type': 'Question',
                    name: 'Jaké dokumenty potřebuji k žádosti o půjčku v Habartově?',
                    acceptedAnswer: {
                      '@type': 'Answer',
                  ...
                  {
                    '@type': 'Question',
                    name: 'Jak dlouho trvá schválení půjčky v Habartově?',
                    acceptedAnswer: {
                      '@type': 'Answer',
                  ...
                  {
                    '@type': 'Question',
                    name: 'Mohu získat půjčku v Habartově se záporným záznamem v registru?',
                    acceptedAnswer: {
                      '@type': 'Answer',
              ...
              {
                '@type': 'OfferCatalog',
                name: 'Nabídky půjček v Habartově',
                itemListElement: [
                  {
                    '@type': 'Offer',
                    itemOffered: {
                      ...
                      description: 'Rychlé nebankovní půjčky pro obyvatele Habartov'
                    }
                  }
                ]
              }
