...
export const metadata = {
  title: 'Půjčky v Sobotka, Královéhradecký kraj – Porovnání 2025',
  description: 'Hledáte půjčku v Sobotka? Porovnejte nabídky bank a nebankovních společností. Rychlé schválení, transparentní podmínky. Zjistěte více.',
}

export default function SobotkaPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <nav className="mb-6 text-sm">
        ...
        {' > '}
        <span className="text-gray-600">Sobotka</span>
      </nav>

      <header className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">
          Půjčky v Sobotka, Královéhradecký kraj
        </h1>
        <div className="prose prose-gray max-w-none">
          <p className="text-lg text-gray-700 leading-relaxed">
            Potřebujete rychlou půjčku v Sobotka? Nabízíme komplexní přehled možností 
          ...
          <CardContent className="pt-6">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 text-center">
              ...
              <p className="text-sm text-gray-600">
                ...
                půjček dostupných v Sobotka a okolí.
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">
                Jaké dokumenty potřebuji pro žádost o půjčku v Sobotka?
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-700">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">
                Jaké jsou alternativy k půjčce v Sobotka?
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-700">
