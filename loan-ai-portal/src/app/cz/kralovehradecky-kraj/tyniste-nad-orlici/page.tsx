...
export const metadata = {
  title: 'Půjčky v Týniště nad Orlicí, Královéhradecký kraj – Porovnání 2025',
  description: 'Hledáte půjčku v Týniště nad Orlicí? Porovnejte nabídky bank a nebankovních společností. Rychlé schválení, transparentní podmínky. Zjistěte více.',
}

export default function TynisteNadOrliciPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <nav className="mb-6 text-sm">
        ...
        {' > '}
        <span className="text-gray-600">Týniště nad Orlicí</span>
      </nav>

      <header className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">
          Půjčky v Týniště nad Orlicí, Královéhradecký kraj
        </h1>
        <div className="prose prose-gray max-w-none">
          <p className="text-lg text-gray-700 leading-relaxed">
            Potřebujete rychlou půjčku v Týniště nad Orlicí? Nabízíme komplexní přehled možností 
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">
          Nabídka půjček v Týniště nad Orlicí
        </h2>
        <Card className="mb-6">
          <CardContent className="pt-6">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 text-center">
              ...
              <p className="text-sm text-gray-600">
                ...
                půjček dostupných v Týniště nad Orlicí a okolí.
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">
                Jaké dokumenty potřebuji pro žádost o půjčku v Týniště nad Orlicí?
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-700">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">
                Jaké jsou alternativy k půjčce v Týniště nad Orlicí?
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-700">
      ...
      <section className="mb-12">
        ...
        <div className="flex flex-wrap gap-4">
          {[
            ...
            <Link 
              key="trebechovice-pod-orebem" 
              href="/cz/kralovehradecky-kraj/trebechovice-pod-orebem"
              className="text-blue-600 hover:underline"
            >
