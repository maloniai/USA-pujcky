...
export const metadata = {
  title: 'Půjčky v Lázně Bělohrad, Královéhradecký kraj – Porovnání 2025',
  description: 'Hledáte půjčku v Lázně Bělohrad? Porovnejte nabídky bank a nebankovních společností. Rychlé schválení, transparentní podmínky. Zjistěte více.',
}

export default function LazneBelohradPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <nav className="mb-6 text-sm">
        ...
        {' > '}
        <span className="text-gray-600">Lázně Bělohrad</span>
      </nav>

      <header className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">
          Půjčky v Lázně Bělohrad, Královéhradecký kraj
        </h1>
        <div className="prose prose-gray max-w-none">
          <p className="text-lg text-gray-700 leading-relaxed">
            Potřebujete rychlou půjčku v Lázně Bělohrad? Nabízíme komplexní přehled možností 
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">
          Nabídka půjček v Lázně Bělohrad
        </h2>
        <Card className="mb-6">
          <CardContent className="pt-6">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 text-center">
              ...
              <p className="text-sm text-gray-600">
                ...
                půjček dostupných v Lázně Bělohrad a okolí.
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">
                Jaké dokumenty potřebuji pro žádost o půjčku v Lázně Bělohrad?
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-700">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">
                Jaké jsou alternativy k půjčce v Lázně Bělohrad?
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-700">
      ...
      <section className="mb-12">
        ...
        <div className="flex flex-wrap gap-4">
          {[
            <Link 
              key="jicin" 
              href="/cz/kralovehradecky-kraj/jicin"
            ...
            <Link 
              key="horice" 
              href="/cz/kralovehradecky-kraj/horice"
              className="text-blue-600 hover:underline"
            >
              Hořice
            </Link>,
            <Link 
              key="nova-paka" 
              href="/cz/kralovehradecky-kraj/nova-paka"
              className="text-blue-600 hover:underline"
            >
              Nová Paka
            </Link>
