    ...
    <div className="container mx-auto px-4 py-8">
      <header className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          Vítejte na AI Portálu Půjček
        </h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Rychlé, bezpečné a inteligentní služby půjček založené na umělé inteligenci.
          Získejte okamžité předběžné schválení a najděte nejlepší možnosti půjček.
        </p>
      </header>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        <Card>
          ...
          <CardContent>
            <p className="text-gray-600 mb-4">
              Požádejte o půjčku během několika minut díky našemu zjednodušenému procesu.
            </p>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-gray-600 mb-4">
              Naše umělá inteligence najde nejlepší možnosti půjček přizpůsobené vašemu profilu.
            </p>
