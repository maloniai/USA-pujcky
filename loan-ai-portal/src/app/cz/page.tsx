    ...
    <div className="container mx-auto px-4 py-8">
      <header className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Rychlé, bezpečné a inteligentní půjčkové služby s podporou AI. 
          Získejte okamžité předběžné schválení a najděte nejlepší varianty půjček pro vaše potřeby.
        </p>
      </header>
      ...
      <div className="text-center">
        <h2 className="text-2xl font-semibold mb-4">Dostupné v mnoha jazycích</h2>
