    ...
    <div className="container mx-auto px-4 py-8">
      <header className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          Vítejte na Portálu AI Půjček
        </h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Rychlé, bezpečné a inteligentní půjčovací služby poháněné umělou inteligencí.
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Informace o Krajích</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-gray-600 mb-4">
            ...
            <Link href="/cz/kraje">
              <Button variant="outline" className="w-full">Zobrazit Kraje</Button>
            </Link>
          </CardContent>
        </Card>
      </div>
