      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-4">
              Plataforma de comparación de créditos personales en Colombia. 
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/co/regions" className="hover:text-white transition">
                  Regiones
                </Link>
              </li>
              <li>
                <Link href="/co/cities" className="hover:text-white transition">
                  Ciudades
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                ...
                <a href="tel:+5713001234567" className="hover:text-white transition">
                  +57 (1) 300-1234567
                </a>
              </li>
              <li className="pt-2">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-gray-400">
          ...
          <div className="mt-4 text-xs text-gray-500">
            <p>
              <strong>Aviso importante:</strong> LoansAI es un servicio de comparación de créditos.
              ...
              los créditos. Todas las instituciones financieras mostradas están debidamente registradas
