      ...
      <div className="space-y-4 text-sm text-gray-700">
        ...
        <div>
          ...
          <p>
            ...
            rate of <strong>15%</strong>, your monthly repayment would be approximately <strong>$346</strong>. 
            The total amount repayable would be <strong>$12,456</strong>, which includes <strong>$2,456</strong> in 
            interest charges.
          </p>
          <p className="mt-2 text-xs text-gray-600">
            ...
            7% to 25% per annum for personal loans in New Zealand.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc list-inside space-y-1 text-gray-700">
            <li>All lenders must be licensed by FMA and hold an New Zealandn Credit Licence</li>
        ...
        <div className="text-xs text-gray-500 mt-4">
          <p>
            This service complies with the Credit Contracts and Consumer Finance Act 2003 (CCCFA) and the Privacy Act 2020. 
            Your personal information is protected and will only be shared with FMA-licensed credit providers 
