...
export const kazakhstanCities: KazakhstanCityInfo[] = [
  ...
  },
  {
    ...
    regionSlug: 'west-kazakhstan',
    population: '0.2M',
    avgLoanAmount: '2,500,000 ₸',
    avgRate: '20.5%',
    description: 'Western border city with cross-border trade and oil industry financing.',
    descriptionKk: 'Трансшекаралық сауда мен мұнай өнеркәсібінің қаржыландыруы бар батыс шекара қаласы.',
    loanTypes: ['Personal Loans', 'Oil Sector', 'Trade Finance', 'Business Loans'],
    loanTypesKk: ['Жеке несиелер', 'Мұнай секторы', 'Сауда қаржысы', 'Бизнес несиелері'],
    nearbyCity: ['Aksai', 'Zhangala', 'Karatobe']
  },
  {
    name: 'Petropavlovsk',
    slug: 'petropavlovsk',
    ...
    regionSlug: 'north-kazakhstan',
    population: '0.2M',
    avgLoanAmount: '2,200,000 ₸',
    avgRate: '21.0%',
    description: 'Northern agricultural center with grain farming and rural development focus.',
    descriptionKk: 'Астық егіншілігі мен ауылдық даму бағыты бар солтүстік ауыл шаруашылығы орталығы.',
    loanTypes: ['Personal Loans', 'Agricultural', 'Rural Development', 'Consumer Credit'],
    loanTypesKk: ['Жеке несиелер', 'Ауыл шаруашылығы', 'Ауылдық даму', 'Тұтынушылық несие'],
    nearbyCity: ['Bulayevo', 'Saumalkol', 'Tayynsha']
  },
  {
    name: 'Zhezkazgan',
    slug: 'zhezkazgan',
    ...
    avgLoanAmount: '2,000,000 ₸',
    avgRate: '22.0%',
    description: 'Historic mining city with copper industry and resource sector financing.',
    descriptionKk: 'Мыс өнеркәсібі мен ресурстар секторының қаржыландыруы бар тарихи тау-кен қаласы.',
    loanTypes: ['Personal Loans', 'Mining', 'Industrial', 'Small Business'],
    loanTypesKk: ['Жеке несиелер', 'Тау-кен', 'Өнеркәсіптік', 'Шағын бизнес'],
    nearbyCity: ['Satpayev', 'Karazhal', 'Ulytau']
  },
  {
    name: 'Rudny',
    slug: 'rudny',
    ...
    avgLoanAmount: '2,300,000 ₸',
    avgRate: '20.5%',
    description: 'Iron ore mining city with industrial and mining sector loans.',
    descriptionKk: 'Өнеркәсіптік және тау-кен секторының несиелері бар темір кені қазу қаласы.',
    loanTypes: ['Personal Loans', 'Mining', 'Industrial Workers', 'Consumer Credit'],
    loanTypesKk: ['Жеке несиелер', 'Тау-кен', 'Өнеркәсіп жұмысшылары', 'Тұтынушылық несие'],
    nearbyCity: ['Kostanay', 'Lisakovsk', 'Dzhetygara']
  },
  {
    name: 'Baikonur',
    slug: 'baikonur',
    ...
    avgLoanAmount: '2,400,000 ₸',
    avgRate: '21.0%',
    description: 'Cosmodrome city with space industry workers and specialized financing.',
    descriptionKk: 'Ғарыш өнеркәсібінің жұмысшылары мен мамандандырылған қаржыландыруы бар космодром қаласы.',
    loanTypes: ['Personal Loans', 'Space Industry', 'Government Workers', 'Consumer Loans'],
    loanTypesKk: ['Жеке несиелер', 'Ғарыш өнеркәсібі', 'Мемлекеттік қызметшілер', 'Тұтынушылық несиелер'],
    nearbyCity: ['Kyzylorda', 'Aralsk', 'Kazalinsk']
  },
  {
    name: 'Ekibastuz',
    slug: 'ekibastuz',
    ...
    avgLoanAmount: '2,400,000 ₸',
    avgRate: '20.0%',
    description: 'Coal mining and power generation city with energy sector financing.',
    descriptionKk: 'Энергетика секторының қаржыландыруы бар көмір өндіру және энергия өндіру қаласы.',
    loanTypes: ['Personal Loans', 'Energy Sector', 'Coal Mining', 'Worker Loans'],
    loanTypesKk: ['Жеке несиелер', 'Энергетика секторы', 'Көмір өндіру', 'Жұмысшы несиелері'],
    nearbyCity: ['Pavlodar', 'Aksu', 'Ertis']
  },
  {
    name: 'Kentau',
    slug: 'kentau',
    ...
    avgLoanAmount: '2,000,000 ₸',
    avgRate: '21.5%',
    description: 'Industrial city with lead and zinc mining, worker-focused lending.',
    descriptionKk: 'Жұмысшыларға бағытталған несие берумен қорғасын және мырыш өндіретін өнеркәсіптік қала.',
    loanTypes: ['Personal Loans', 'Mining Workers', 'Small Business', 'Consumer Credit'],
    loanTypesKk: ['Жеке несиелер', 'Тау-кен жұмысшылары', 'Шағын бизнес', 'Тұтынушылық несие'],
    nearbyCity: ['Turkistan', 'Shymkent', 'Arys']
  },
  {
    name: 'Zhanaozen',
    slug: 'zhanaozen',
    ...
    avgLoanAmount: '2,800,000 ₸',
    avgRate: '19.5%',
    description: 'Oil industry city with high-income workers and energy sector loans.',
    descriptionKk: 'Жоғары табысты жұмысшылар мен энергетика секторының несиелері бар мұнай өнеркәсібі қаласы.',
    loanTypes: ['Personal Loans', 'Oil & Gas', 'High-Income Workers', 'Auto Loans'],
    loanTypesKk: ['Жеке несиелер', 'Мұнай-газ', 'Жоғары табысты жұмысшылар', 'Автокредит'],
    nearbyCity: ['Aktau', 'Fort-Shevchenko', 'Shetpe']
  },
  {
    name: 'Kandyagash',
    slug: 'kandyagash',
    ...
    avgLoanAmount: '2,300,000 ₸',
    avgRate: '20.5%',
    description: 'Mining city with chromium production and industrial worker financing.',
    descriptionKk: 'Хром өндірісі мен өнеркәсіптік жұмысшыларды қаржыландыруы бар тау-кен қаласы.',
    loanTypes: ['Personal Loans', 'Mining', 'Industrial', 'Small Loans'],
    loanTypesKk: ['Жеке несиелер', 'Тау-кен', 'Өнеркәсіптік', 'Шағын несиелер'],
    nearbyCity: ['Aktobe', 'Khromtau', 'Shalkar']
  }
]
