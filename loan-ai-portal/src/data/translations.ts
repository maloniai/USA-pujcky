	...
	cs: {
		...
		sections: [
			...
			},
			{
				...
				links: [
					{ label: 'Praha', href: '/cz/regions/praha' },
					{ label: 'Brno', href: '/cz/regions/jihomoravsky' },
					{ label: 'České Budějovice', href: '/cz/regions/jihocesky/ceske-budejovice' },
					{ label: 'Plzeň', href: '/cz/regions/plzensky' },
				],
			},
			{
				heading: 'Zdroje',
				links: [
					{ label: 'Blog', href: '/blog' },
					{ label: 'Požádat o úvěr', href: '/cz/zadost' },
					{ label: 'FAQ', href: '/faq' },
