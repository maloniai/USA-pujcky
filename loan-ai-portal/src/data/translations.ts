...
const footerTranslations: Record<Locale, FooterLabels> = {
	...
	cs: {
		...
		sections: [
			...
			{
				heading: 'Žádost o půjčku',
				links: [
					{ label: 'Online žádost', href: '/cz/apply' },
					{ label: 'AI doporučení', href: '/cz#regional-guides' },
					{ label: 'Srovnání RPSN', href: '/cz' },
					{ label: 'Regionální průvodci', href: '/cz#regional-guides' },
				],
			},
			{
				heading: 'Zdroje',
				links: [
					{ label: 'Blog', href: '/blog' },
					{ label: 'České regiony', href: '/cz' },
					{ label: 'FAQ', href: '/faq' },
					{ label: 'Vyloučení odpovědnosti', href: '/disclaimer' },
					{ label: 'Licencování ČNB', href: '/licenses' },
				],
			},
		],
		disclosures: [
